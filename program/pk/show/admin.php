...
foreach($r as $v){
	...
	<td>".$v['username']."</td>
	<td>".$v['visit']."</td>
  <td class=operation_td><a href='index.php?monxin=".$class.".show&pk_id=".$v['id']."' target=_blank  class='view'>".self::$language['view']."</a><a href='#' onclick='return del(".$v['id'].")'  class='del'>".self::$language['del']."</a> <span id=act_state_".$v['id']." class='act_state'></span></td>
</tr>
";	
}
