...
$module['module_name']=str_replace("::","_",$method);
		...
		function get_list($pdo,$language,$parent,$table_pre,$class){
			...
			foreach($r as $v){
			  ...
			  <td><input type='text' name='sequence_".$v['id']."' id='sequence_".$v['id']."' value='".$v['sequence']."' class='sequence' /> <a href=./index.php?monxin=image.type_remark&id=".$v['id']." class=remark>".$language['remark']."</a></td>
