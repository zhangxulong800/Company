...
$module['module_name']=str_replace("::","_",$method);
		...
		$module['action_url']="receive.php?target=index::edit_page_layout&act=update_attribute&old_module=travel.type_module".$_GET['args'].'&url='.$_GET['url'].'&new_module=travel.type_module';
