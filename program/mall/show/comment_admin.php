...
$sql="select * from ".self::$table_pre."comment where `shop_id`=".SHOP_ID;
...
foreach($r as $v){
	...
	$list.="<tr id='tr_".$v['id']."'>
	<td>
		<a href='./index.php?monxin=mall.order_admin&id=".$v['order_id']."' target=_blank class=goods_title>".@$r2['title']."</a>
		...
		<div class=seller>".$answer."</div>
  		...
  		<td class=operation_td><a href='index.php?monxin=".$class.".comment_answer&id=".$v['id']."' target=_blank class='edit'>".self::$language['answer']."</a> <span id=state_".$v['id']." class='state'></span></td>
</tr>
";	
}
