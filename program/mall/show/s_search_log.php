...
$sql="select * from ".self::$table_pre."shop_search_log where `shop_id`=".SHOP_ID;
...
foreach($r as $v){
	...
	<td><div class=keyword><a href='./index.php?monxin=mall.goods_list&search=".urlencode($v['keyword'])."&click=true' target=_blank>".$v['keyword']."</a></div></td>
	<td>".$v['sum']."</td>
	<td>".$v['year']."</td>
	<td>".$v['month']."</td>
	<td>".$v['week']."</td>
