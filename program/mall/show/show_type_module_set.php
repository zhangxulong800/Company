...
$module['action_url']="receive.php?target=index::edit_page_layout&act=update_attribute&old_module=mall.show_type_module".$_GET['args'].'&url='.$_GET['url'].'&new_module=mall.show_type_module';
