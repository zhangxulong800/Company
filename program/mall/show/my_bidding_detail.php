...
$sql="select * from ".self::$table_pre."bidding where `shop_id`=".SHOP_ID;
...
if(isset($_GET['gid'])){
	...
	if($gid>0){
		...
		$goods_name=$r2['title'];
		echo '<div  style="display:none;" id="user_position_append"><a href="./index.php?monxin=mall.my_bidding_detail">'.self::$language['pages']['mall.my_bidding_detail']['name'].'</a><span class=text>'.$goods_name.'</span></div>';
	}
}
