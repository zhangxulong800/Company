<?php
		...
		if($act=='add'){
			...
			$sql="insert into ".self::$table_pre."type (`parent`,`name`,`sequence`,`visible`,`manager`,`read_power`,`title_power`,`content_power`) values ('".$_GET['parent']."','".$_GET['name']."','".$_GET['sequence']."','".$_GET['visible']."','".$_SESSION['monxin']['username']."','".@$r['read_power']."','".@$r['title_power']."','".@$r['content_power']."')";
			if($pdo->exec($sql)){
