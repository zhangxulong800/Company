...
foreach($r as $v){
  ...
  <td class=operation_td><a href='index.php?monxin=".$class.".content_edit&id=".$v['id']."' target=_blank  class='edit'>".self::$language['edit']."</a> <a href='#' onclick='return del(".$v['id'].")'  class='del'>".self::$language['del']."</a><span id=state_".$v['id']." class='state'></span></td>
</tr>
";	
}
