...
$module['state_option']='<a href=./index.php?monxin=gbuy.order class=current>'.self::$language['all'].'</a>';
foreach(self::$language['order_state_option'] as $k=>$v){
	$module['state_option'].='<a href=./index.php?monxin=gbuy.order&state='.$k.' state='.$k.'>'.$v.'</a>';
}
