...
foreach($r as $v){
	...
	$pdo->exec($sql);
		...
		$list.="<tr id='tr_".$v['id']."'>
			...
			<td><a href=./index.php?monxin=gbuy.goods_view&id=".$v['id']." class=goods_view>".self::$language['view']."</a> <a href='#' onclick='return del(".$v['id'].")'  class='del'>".self::$language['del']."</a> <span id=state_".$v['id']." class='state'></span></td>
		</tr>";
