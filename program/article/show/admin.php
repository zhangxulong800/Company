...
foreach($r as $v){
	...
	$img='';
	if($v['src']!=''){
		$img="<br /><a href='index.php?monxin=".$class.".show&id=".$v['id']."&type=".$_GET['type']."&search=".urlencode($_GET['search'])."&order=".$_GET['order']."' target=_blank><img src='./program/article/img_thumb/".$v['src']."' class=thumb_article /></a>";	
	}
