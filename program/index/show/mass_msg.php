...
$list.="<li><a href=index.php?monxin=index.config&id=sms ><img src='./templates/1/index/".self::$config['program']['template_1']."/page_icon/index.config&id=sms.png' /><br><span>".self::$language['config_language']['sms']['this_name']."</span></a></li>";
