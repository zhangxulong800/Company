...
$id=intval(@$_GET['id']);
if($id>0){
	$sql="select `time`,`sender`,`title`,`content` from ".$pdo->index_pre."site_msg where `id`='$id' and (`addressee`='".$_SESSION['monxin']['username']."' or `sender`='".$_SESSION['monxin']['username']."')";
