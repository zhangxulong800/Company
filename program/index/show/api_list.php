...
foreach($r as $v){
	...
	<td><input type='text' name='api_".$v['id']."' id='api_".$v['id']."' class='api' value='".$v['api']."' /></td>
	<td><input type='text' name='name_".$v['id']."' id='name_".$v['id']."' class='name' value='".$v['name']."' /></td>
	<td><input type='text' name='doc_url_".$v['id']."' id='doc_url_".$v['id']."' class='doc_url' value='".$v['doc_url']."' /></td>
