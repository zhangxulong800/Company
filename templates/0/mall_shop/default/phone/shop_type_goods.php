<div id=<?php echo $module['module_name'];?> monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		//$("html,body").animate({scrollTop: $("#<?php echo $module['module_name'];?>").offset().top-45}, 1000);
...
temp=old_cart;
	...
	#<?php echo $module['module_name'];?> .goods_list_div{ text-align:right; display:inline-block; vertical-align:top; width:80%; height:100%;  white-space:normal; overflow:hidden; background:#fff;overflow: hidden;}
	#<?php echo $module['module_name'];?> .goods_list_div .g_module{ text-align:left;}
	#<?php echo $module['module_name'];?> .goods_list_div .g_module a{}

	#<?php echo $module['module_name'];?>_html  .goods{ display:inline-block; vertical-align:top; vertical-align:top;; width:32%; height:12.5rem; overflow:hidden; margin-left:1%;   white-space:nowrap; text-align:left; white-space:nowrap;}
	...
	#<?php echo $module['module_name'];?>_html  .goods .goods_a img{  height:6rem; margin-top:1rem; border:none;}
	...
	#<?php echo $module['module_name'];?>_html  .goods .price_span{ display:inline-block; vertical-align:top; text-align:left;  line-height:1.2rem	; overflow:hidden;  font-size:0.9rem;padding-left:10px;  width:100%; overflow:hidden; text-overflow: ellipsis;color:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>;}
	...
	#<?php echo $module['module_name'];?> .type_list_div{ display:inline-block; vertical-align:top; width:20%; height:100%; overflow:hidden;white-space:normal;background-color:rgba(247,247,247,1); color:#000;}
	...
	#<?php echo $module['module_name'];?> .type_list_div .type_0{ font-size:1rem; font-weight:bold;}
	#<?php echo $module['module_name'];?> .type_list_div .type_1{ font-size:0.9rem;}
	...
	#<?php echo $module['module_name'];?> .goods_list_div .no_scroll{ width:103%;overflow:scroll; height:400px; padding-top:10px; padding-bottom:2rem;}
	#<?php echo $module['module_name'];?> .type_list_div .no_scroll{width:112%;overflow:scroll; height:400px; padding-top:10px;  padding-bottom:2rem;}
	...
	#<?php echo $module['module_name'];?>_html .goods .price_span{ font-size:0.8rem;}
	#<?php echo $module['module_name'];?>_html .goods .price_span .money_value{ font-size:1rem;}
	#<?php echo $module['module_name'];?>_html .goods .price_span .money_symbol{ font-size:0.8rem; padding-left:1px;}

#<?php echo $module['module_name'];?>_html .yuan_2{ display:block; line-height:1rem;  padding-left:10px;color:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>; font-size:0.8rem; line-height:1.2rem;}
