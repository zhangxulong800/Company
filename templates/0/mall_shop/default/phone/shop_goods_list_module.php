...
#<?php echo $module['module_name'];?>_html .module_title{font-size:1.1rem; height:3rem;line-height:3rem;  border-bottom:3px solid <?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>; padding-right:25px; overflow:hidden;box-shadow:0px 1px 5px #ccc; text-indent:10px; box-shadow:none;}

#<?php echo $module['module_name'];?>_html .module_title .sub_type{ display:inline-block; vertical-align:top;font-size:1rem; line-height:2rem; padding-top:1rem;}
#<?php echo $module['module_name'];?>_html .module_title .sub_type a{ display:inline-block; vertical-align:top; min-width:47%; text-align:center; }
...
#<?php echo $module['module_name'];?>_html .module_title .name span{    font-weight:bold; padding-left:5px; padding-right:5px; margin-right:5px;}
#<?php echo $module['module_name'];?>_html .module_title .more{ float:right; color:#999;}
#<?php echo $module['module_name'];?>_html .module_title .more:hover{  }
...
#<?php echo $module['module_name'];?>_html .list  .goods{ display:inline-block; vertical-align:top; vertical-align:top;; width:50%; height:20.5rem; overflow:hidden;  border-bottom:1px solid #e7e7e7; white-space:nowrap; text-align:left;}
...
#<?php echo $module['module_name'];?>_html .list  .goods .goods_a .title{ display:block; text-align:left; margin-left:0.5rem;  height:28px; line-height:28px; overflow:hidden; font-size:15px;  white-space: nowrap;text-overflow: ellipsis; margin-bottom:0px !important;}
...
#<?php echo $module['module_name'];?>_html .list  .line .goods_img{ vertical-align:top;text-align:right;  display:inline-block; vertical-align:top; width:25%; overflow:hidden;}
#<?php echo $module['module_name'];?>_html .list  .line .goods_img img{ width:100%; margin:auto; overflow:hidden; border:none;}
#<?php echo $module['module_name'];?>_html .list  .line .good_info{ vertical-align:top; display:inline-block; vertical-align:top; padding-left:1%;overflow:hidden; width:65%;}
#<?php echo $module['module_name'];?>_html .list  .line .good_info:hover{}
#<?php echo $module['module_name'];?>_html .list  .line .good_info .title{ display:block; ; overflow:hidden; font-size:1rem;  line-height:2rem; height:4rem; overflow:hidden;}
#<?php echo $module['module_name'];?>_html .list  .line .good_info .price_span{ display:inline-block; vertical-align:top;  overflow:hidden;  font-family:Georgia;  font-weight:bold; height:60px; line-height:60px;color:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>;  width:60%; overflow: hidden; white-space:nowrap;text-overflow: ellipsis;}

#<?php echo $module['module_name'];?>_html .hover_list{ display:none;}

#<?php echo $module['module_name'];?>_html .list .goods .button_div{ display:inline-block; vertical-align:top;line-height:30px;  width:40%; overflow: hidden;text-align:right;}
#<?php echo $module['module_name'];?>_html .list .line .button_div{ height:60px; overflow:hidden; line-height:60px; display:inline-block; vertical-align:top; float:right;   width:40%; overflow: hidden;text-align:right;}
#<?php echo $module['module_name'];?>_html .list .add_cart{ display:inline-block;  height:30px; line-height:30px; border-radius:2px; font-size:1rem;  padding-left:5px;padding-right:5px;}
