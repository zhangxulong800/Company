...
$(document).ready(function(){
	...
	function showPosition(position){
		...
		if(userAgent.indexOf('baidu')==-1){
			...
			longitude=position.coords.longitude+0.011;
		}
		v=latitude+','+longitude;
		$("#map").attr('src',$("#map").attr('src')+'&latlng='+v);
		$("#<?php echo $module['module_name'];?> .navigate").attr('href',$("#<?php echo $module['module_name'];?> .navigate").attr('href').replace(/\{user_latlng\}/,v));
		//alert($("#<?php echo $module['module_name'];?> .navigate").attr('href'));
...
#<?php echo $module['module_name'];?>_html .position{ display:none; clear:both; border-bottom:2px solid #ff9600;margin:auto; font-weight:bold; padding-bottom:5px; margin-top:5px; padding-left:15px;  margin-bottom:10px;color: #999;}
...
.my_contact_info{ padding:0.5rem;color: #999;}
...
.my_contact_info .my_tel .my_head:before{font: normal normal normal 1.3rem/1 FontAwesome; content: "\f098";margin-right:3px;} 
.my_contact_info .my_tel .my_content{ margin:10px;  font-size:1.28rem; font-weight:bold; line-height:40px;}
...
.my_contact_info .my_qq .my_head:before{font: normal normal normal 1.3rem/1 FontAwesome; content: "\f1d6";margin-right:3px;} 
.my_contact_info .my_qq #my_qq{ font-size:1.28rem;line-height:2.85rem;}
...
.my_contact_info .address .my_head:before{font: normal normal normal 1.3rem/1 FontAwesome; content: "\f041";margin-right:3px;} 
.my_contact_info .address .my_content{ font-size:1.28rem;}
.my_contact_info .address .my_content a{}
	...
	.my_contact_info .my_wx .wx_line .wx_name:before { font: normal normal normal 14px/1 FontAwesome;   margin-right: 7px;    content:"\f1d7"; color:#999;}
