...
#<?php echo $module['module_name'];?> .nv ul {list-style: none;position: relative;display: inline-block;white-space:nowrap; z-index:999999999999;}
...
#<?php echo $module['module_name'];?> .nv ul li:hover {background: #ff4a00;}
...
#<?php echo $module['module_name'];?> .nv ul ul {line-height:40px;line-height:2.85rem;background: #ff4a00; border-radius: 0px; padding: 0;position: absolute; top: 100%;}
...
#<?php echo $module['module_name'];?> .nv ul ul li:hover {background:#ff9900;}
...
#<?php echo $module['module_name'];?> .nv ul li:last-child:hover >  ul li ul a{padding-right: 25px ;}
    ...
    <div class=nv>
        <div class="container"><ul class=nv_ul ><?php echo $module['data'];?></ul>
    </div>
