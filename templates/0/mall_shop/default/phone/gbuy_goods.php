<div id=<?php echo $module['module_name'];?>  save_name="<?php echo $module['module_save_name'];?>"  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left  >
	...
	function set_credits_value(){
		return false;
		if($("#<?php echo $module['module_name'];?> .discount_price .price_value").html()){
			temp=$("#<?php echo $module['module_name'];?> .discount_price .price_value").html();
		}else{
			temp=$("#<?php echo $module['module_name'];?> #no_discount .price_value").html();
		}
		if(!temp){
			temp=$("#<?php echo $module['module_name'];?> .pre_price .price_value").html();
		}
		temp=temp.split('-');
		if(temp[1]){
			temp=Math.floor(temp[0])+'-'+Math.floor(temp[1]);
		}else{
			temp=Math.floor(temp[0]);
		}
		temp=temp*<?php echo $module['credits_multiple']?>;
		$("#<?php echo $module['module_name'];?> .credits .value").html(temp.toFixed(2));
	}
    ...
    $(document).ready(function(){
		if(get_param('group')!=''){
			$("#<?php echo $module['module_name'];?> .goods_bottom_div a").css('display','none');
			$("#<?php echo $module['module_name'];?> .goods_bottom_div .gbuy_buy .t").html('拼团购买');
			$("#<?php echo $module['module_name'];?> .goods_bottom_div .gbuy_buy").css('display','block').css('width','100%').css('padding-right','30px');
			$("#<?php echo $module['module_name'];?> .group_list").css('display','none');
		}
		...
		if(!gbuying){$("#<?php echo $module['module_name'];?> .group_list_div").css('display','none');}
		...
		$("#<?php echo $module['module_name'];?>_html .gbuy_buy").click(function(){
			if(specifications){
				if(s_id==0){
					show_goods_option_div(1);
					if($("#<?php echo $module['module_name'];?> .goods_option_div").css('right')=='0px'){
    ...
    #<?php echo $module['module_name'];?>_html #goods_act_div #act_div .price_info .price_div #have_discount .discount_price .money_symbol{ font-size:24px; font-weight:bold; }
	...
	#<?php echo $module['module_name'];?>_html #relevance_package_div .result_div .save_money .money_symbol{}
	#<?php echo $module['module_name'];?>_html #relevance_package_div .result_div .save_money .value{ font-weight:bold;}
    ...
    #<?php echo $module['module_name'];?>_html .goods_div .money_value{  font-size:13px;}
    ...
    #<?php echo $module['module_name'];?>_html #relevance_goods_div a .money_symbol{  font-size:13px; text-align:left; display:inline-block; vertical-align:top;}
    #<?php echo $module['module_name'];?>_html #relevance_goods_div a .money_value{  font-size:13px; text-align:left; display:inline-block; vertical-align:top; }
	...
	#<?php echo $module['module_name'];?>_html #goods_detail_div #goods_detail #goods_attribute div{ display:inline-block; vertical-align:top; width:48%;  display:inline-block; vertical-align:top; height:25px; line-height:25px; white-space:nowrap;overflow:hidden; white-space:nowrap; text-overflow: ellipsis;} 
	#<?php echo $module['module_name'];?>_html #goods_detail_div #goods_detail #goods_attribute div .a_label{ display:inline-block; vertical-align:top; margin-right:8px; width:70px; text-align:right; overflow:hidden; height:30px; vertical-align:top;opacity:0.5; font-size:0.8rem;}
	#<?php echo $module['module_name'];?>_html #goods_detail_div #goods_detail #goods_attribute div .a_value{  vertical-align:top;}
	#<?php echo $module['module_name'];?>_html #goods_detail_div #goods_detail #goods_detail_html{ margin-top:20px; line-height:30px; width:95.8%; padding:2%}
	...
	#<?php echo $module['module_name'];?>_html #pre_sale .pre_deposit .deposit_value{ font-size:24px; font-weight:bold; margin-right:30px;}
	...
	.goods_bottom_div .mall_buy{background:<?php echo $_POST['monxin_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['monxin_user_color_set']['nv_2_hover']['text']?> !important;  }
	...
	.goods_option_div .goods_content div .gbuy_price{color:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>; }
	.goods_option_div .goods_content div .gbuy_price:before{ font: normal normal normal 1rem/1 FontAwesome; content:"<?php echo self::$language['money_symbol'];?>"; padding-right:2px;}	
	...
	#<?php echo $module['module_name'];?>_html .mall_buy{ line-height:1.8rem; width:25%; }
	#<?php echo $module['module_name'];?>_html .mall_buy span{ display:block; height:1.8rem; overflow:hidden;}
	#<?php echo $module['module_name'];?>_html .mall_buy .price{ line-height:2.5rem;}
	
	#<?php echo $module['module_name'];?>_html .gbuy_buy{ line-height:1.8rem; }
	#<?php echo $module['module_name'];?>_html .gbuy_buy span{ display:block; height:1.8rem; overflow:hidden;}
	#<?php echo $module['module_name'];?>_html .gbuy_buy .price{ line-height:2.5rem;}
	
	#<?php echo $module['module_name'];?> .shop_info{ display:none;}
	#<?php echo $module['module_name'];?> .goods_bottom_div{ width:100% !important; white-space:nowrap;}
	#<?php echo $module['module_name'];?> .goods_bottom_div .gbuy_buy{ width:42%;}
	
	#<?php echo $module['module_name'];?> .price_info{ display:none !important;}
	.fulfil_preferential{display:none !important;}
    </style>
    ...
    <div id="<?php echo $module['module_name'];?>_html">
        <div class=goods_option_div>
        	...
        	<div class=goods_content>
            	<img src= /><div>
                    ...
                    <span class=gbuy_price><?php echo $module['gbuy_price']?></span>
                </div>
            </div>
		...
		<div class=goods_bottom_div>
        	<a class=talk talk="<?php echo $module['shop_master'];?>" title="<?php echo self::$language['site_msg']?>" ><?php echo self::$language['talk']?></a><a href="./index.php?monxin=mall.shop_index&shop_id=<?php echo $module['shop_id'];?>" class=enter_store><?php echo self::$language['enter_store']?></a><a href="" class=favorite><?php echo self::$language['favorite']?></a><a href="./index.php?monxin=mall.goods&id=<?php echo $_GET['id']?>" class=mall_buy><span class=price><?php echo self::$language['money_symbol']?><?php echo $module['mall_price']?></span><span class=t><?php echo self::$language['mall_buy']?></span></a><a  href="./index.php?monxin=mall.gbuy_confirm_order&goods_src=goods_id&id=<?php echo $_GET['id']?>&group=<?php echo @$_GET['group']?>" rel="nofollow" id=submit class=gbuy_buy><span class=price><?php echo self::$language['money_symbol']?><?php echo $module['gbuy_price']?></span><span class=t><?php echo self::$language['gbuy_buy']?></span></a>
        </div>
	...
	#<?php echo $module['module_name'];?> .group_list{ white-space:nowrap; background:#fff; padding-left:5px;}
	#<?php echo $module['module_name'];?> .group_list .or{ line-height:40px; border-bottom:1px solid #ccc; padding-bottom:3px; padding-top:3px;}
	#<?php echo $module['module_name'];?> .group_list .or >span{ display:inline-block; vertical-align:top; overflow:hidden;}
	#<?php echo $module['module_name'];?> .group_list .or .icon_s{ width:12%;}
	#<?php echo $module['module_name'];?> .group_list .or .name_s{ width:38%;}
	#<?php echo $module['module_name'];?> .group_list .or .remain{ width:30%; line-height:20px;}
	#<?php echo $module['module_name'];?> .group_list .or .remain .remain_order{}
	#<?php echo $module['module_name'];?> .group_list .or .remain .remain_time{ font-size:0.8rem; color:#999;}
	
	#<?php echo $module['module_name'];?> .group_list .or .act_s{ width:20%; text-align:right; padding-right:10px;}
	#<?php echo $module['module_name'];?> .group_list .or .act_s a{ display:block; text-align:center; background:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>; color:#fff; border-radius:5px; line-height:2rem; margin-top:0.4rem;}
	#<?php echo $module['module_name'];?> .group_list .or .icon_s img{ width:40px; height:40px; border-radius:20px;}
	#<?php echo $module['module_name'];?>  .group_list_title{border-bottom:1px solid #ccc solid; line-height:3rem; padding-left:5px; }
    </style>
        ...
        <div class=group_list_div><div class=group_list_title><?php echo self::$language['she_gbuying']?></div><div class=group_list><?php echo $module['group_list'];?></div></div>
