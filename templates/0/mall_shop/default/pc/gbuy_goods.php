...
<div id=<?php echo $module['module_name'];?>  save_name="<?php echo $module['module_save_name'];?>"  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    $(document).ready(function(){
		...
		$("#myModal .modal-body img").attr('src','./plugin/qrcode/index.php?text='+ window.location.href.replace(/&/g,'|||')+'&logo=1');
	...
	#diymodule_show_122,#mall_shop_name,#mall_shop_search,#mall_cart{ display:none !important;}
...
div.zoomMask{position:absolute;background:url("<?php echo get_template_dir(__FILE__);?>img/mask.png") repeat scroll 0 0 transparent;cursor:move;z-index:1;}
    ...
    #<?php echo $module['module_name'];?>_html #relevance_goods_div a .money_symbol{  font-size:13px; text-align:left; display:inline-block; vertical-align:top; width:8%;}
    #<?php echo $module['module_name'];?>_html #relevance_goods_div a .money_value{  font-size:13px; text-align:left; display:inline-block; vertical-align:top; width:92%;}
	...
	#<?php echo $module['module_name'];?> .m_button >a{ display:none !important;}
	#<?php echo $module['module_name'];?> .gbuy_price{ line-height:3rem; font-size:1.6rem; padding-left:10px;}
	#<?php echo $module['module_name'];?> .gbuy_price span{ font-weight:bold;}
	#<?php echo $module['module_name'];?> .mall_price{ line-height:2rem;  padding-left:10px;opacity:0.7;}
	#<?php echo $module['module_name'];?> .mall_price span{text-decoration: line-through; }
    </style>
    	...
    	<div id="goods_act_div">
        	<div id="thumb_img_div">
                ...
                <div class=price_info><?php echo @$module['data']['price_info'];?>
                	<div class=price_div>
                        <div class=mall_price><?php echo self::$language['mall_price']?>:<?php echo self::$language['money_symbol']?><span><?php echo $module['mall_price']?></span></div>
                    	<div class=gbuy_price><?php echo self::$language['gbuy_price']?>:<?php echo self::$language['money_symbol']?><span><?php echo $module['gbuy_price']?></span></div>
                    </div>
                </div>
