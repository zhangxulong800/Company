...
#<?php echo $module['module_name'];?> { margin-top:5px; white-space:normal; background:none !important; padding:0px; margin-top:1rem;}
#<?php echo $module['module_name'];?> a{ }
#<?php echo $module['module_name'];?> k{ }
#<?php echo $module['module_name'];?>_html{}
#<?php echo $module['module_name'];?>_html .top{ display:inline-block; vertical-align:top;  border:1px solid #e7e7e7; border-top:3px solid #ff9600; width:100%; margin-bottom:10px; padding-bottom:10px; margin-bottom:1rem;}
...
#<?php echo $module['module_name'];?>_html .top .top_html a{ display:inline-block; vertical-align:top; height:25px; line-height:25px; border-bottom:3px solid #fff; margin-bottom:5px; margin-top:5px; font-size:15px; margin-right:1.2rem;}
...
#<?php echo $module['module_name'];?>_html .list{  border:1px solid #e7e7e7; padding-bottom:1.2rem;}
#<?php echo $module['module_name'];?>_html .list .m_label_div{ display:inline-block; vertical-align:top; height:4rem;line-height:4rem;  border-bottom:1px solid #e7e7e7; width:100%;background-color: #f3f3f3; color:#999;}
#<?php echo $module['module_name'];?>_html .list .m_label_div .left_label{ display:inline-block; vertical-align:top; width:80%; overflow:hidden; height:4rem; line-height:4rem; }
#<?php echo $module['module_name'];?>_html .list .m_label_div .left_label .order_div{display:inline-block; vertical-align:top;line-height:4rem;}
#<?php echo $module['module_name'];?>_html .list .m_label_div .left_label .order_div a{ display:inline-block; vertical-align:top; padding-right:1.2rem; font-size:1.2rem;  padding-left:1.2rem; color:#999;}
...
#<?php echo $module['module_name'];?>_html .list .m_label_div .right_label{ display:inline-block; vertical-align:top; width:20%; text-align:right; overflow:hidden; line-height:4rem; height:4rem; }
#<?php echo $module['module_name'];?>_html .list .m_label_div .right_label a{ display:inline-block; vertical-align:top;color:#999;}
#<?php echo $module['module_name'];?>_html .list .m_label_div .right_label #show_grid{ display:inline-block; vertical-align:top; line-height:4rem; height:4rem; width:4rem;  text-align: center; padding-top:0.4rem; }
...
#<?php echo $module['module_name'];?>_html .list .m_label_div .right_label #show_line{ display:inline-block; vertical-align:top; height:4rem; width:4rem; line-height:4rem; text-align: center; padding-top:0.4rem;}
...
#<?php echo $module['module_name'];?>_html .list .goods_list{ padding-top:10px;}



#<?php echo $module['module_name'];?>_html .list .goods_list .goods{ display:inline-block; vertical-align:top; vertical-align:top;  width:19.2%; height:22rem;  overflow:hidden; border:4px solid #fff; margin:0.5%; background:#fff;	}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .goods:hover{ border:4px solid <?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>;}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .goods .goods_a .price_span{ display:inline-block; text-align:left;height:2rem; line-height:2rem overflow:hidden;  color:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?> !important; float:left;}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .goods .goods_a .sum_div{ display:block;height:2rem; line-height:2rem;overflow:hidden;  font-size:1rem;font-family:Georgia;}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .goods .button_div{ display:none; padding-left:10px; padding-right:10px;}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .goods .button_div .favorite{display:inline-block; vertical-align:top; float:right; display:inline-block; vertical-align:top; height:2rem; line-height:2rem; border-radius:2px;font-size:1rem;  padding-right:10px;background:<?php echo $_POST['monxin_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['monxin_user_color_set']['nv_2_hover']['text']?>; }
...
#<?php echo $module['module_name'];?>_html .list .goods_list .line{width:100%; padding-top:15px; padding-bottom:15px; border:4px solid #fff; border-bottom:1px solid #e7e7e7; overflow:hidden;margin-bottom:3px; white-space:nowrap; background:#fff;	}}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .line .goods_img{ vertical-align:top;text-align:right;  display:inline-block; vertical-align:top; width:10%; min-width:11.2rem; overflow:hidden;}
#<?php echo $module['module_name'];?>_html .list .goods_list .line .goods_img img{ width:11.2rem; height:11.2rem; margin:auto; overflow:hidden; border:none;}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .line .good_info .top2 .title{ display:inline-block; vertical-align:top; width:70%; margin-right:5%; overflow:hidden; font-size:18px;  line-height:30px; height:60px; white-space:normal; overflow:hidden ;}
#<?php echo $module['module_name'];?>_html .list .goods_list .line .good_info .top2 .price_span{ text-align:right; display:inline-block; vertical-align:top; overflow:hidden; font-size:1rem; font-family:Georgia;  font-weight:bold; max-width:25%; height:30px; line-height:30px; white-space:nowrap;color:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?> !important;}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .line .good_info .bottom .sum_div .monthly .value{ padding-left:5px;}
#<?php echo $module['module_name'];?>_html .list .goods_list .line .good_info .bottom .sum_div .satisfaction{ margin-left:50px;}
#<?php echo $module['module_name'];?>_html .list .goods_list .line .good_info .bottom .button_div{  display:none; text-align:right;width:45%; overflow:hidden; line-height:30px;}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .line .good_info .bottom .button_div .add_cart{ display:inline-block; vertical-align:top; display:inline-block; vertical-align:top; height:30px; line-height:30px; border-radius:3px; font-size:1rem;  padding-right:10px;}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .line .good_info .bottom .button_div .favorite{display:inline-block; vertical-align:top; float:right;  height:30px; line-height:30px; border-radius:2px;  font-size:1rem;  padding-right:10px; margin-left:2rem;background:<?php echo $_POST['monxin_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['monxin_user_color_set']['nv_2_hover']['text']?>; }
...
#<?php echo $module['module_name'];?>_html .line .yuan_2{ padding-right:3rem;}
