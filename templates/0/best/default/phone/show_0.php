...
#<?php echo $module['module_name'];?> .paragraph{ clear:both; margin-bottom:1.5rem; padding:0.5rem;}
...
.xmjs .line_1{}
.xmjs .line_1 .left_icon{ text-align:center; }
.xmjs .line_1 .left_icon img{width:70%;}
.xmjs .line_1 .right_info{}
.xmjs .line_1 .right_info .djs{ text-indent:2rem;}
...
#<?php echo $module['module_name'];?>_html .top_nv .b_right{}
#<?php echo $module['module_name'];?>_html .top_nv .b_right a{ display:none;}
#<?php echo $module['module_name'];?>_html .top_nv .b_right span{ display:none !important;}
#<?php echo $module['module_name'];?>_html .top_nv .b_right a:last-child{ display:inline-block; margin-right:5px;}
</style>
