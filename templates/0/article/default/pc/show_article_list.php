...
#<?php echo $module['module_name'];?>_html{ padding:1rem;}
#<?php echo $module['module_name'];?>_html .module_title{ font-weight:bolder; font-size:1.57rem;}
#<?php echo $module['module_name'];?>_html .list{}
#<?php echo $module['module_name'];?>_html .list a{  margin:5px; margin-bottom:1.42rem; display:inline-block;  width:<?php echo $module['sub_module_width'];?>; overflow:hidden; vertical-align:top; text-align:left;  border:1px solid #e7e7e7; white-space:nowrap;}
...
#<?php echo $module['module_name'];?>_html .list .text{ display:inline-block; padding:5px; vertical-align:middle; width: 85%;margin-right: 10px; white-space:normal;}
...
#<?php echo $module['module_name'];?>_html .hove_icon .text{ display:inline-block; vertical-align:top; width:85%; overflow:hidden;}
#<?php echo $module['module_name'];?>_html .hove_icon .img{display:inline-block; vertical-align:top; width:15%; overflow:hidden;}
