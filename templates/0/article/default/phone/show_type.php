...
$(document).ready(function(){
	...
	if(monxin=='article.show_article_list' && get_param('type')!=''){
...
#<?php echo $module['module_name'];?>_html .type .article_type_deep_2{display:<?php echo $module['page_type_deep_2'];?>;}
#<?php echo $module['module_name'];?>_html .type .article_type_deep_3{display:<?php echo $module['page_type_deep_3'];?>;}
#<?php echo $module['module_name'];?>_html .type .article_type_deep_1 a{padding-left:25px; border-bottom:1px solid #f3f3f3;font-size:1.28rem; line-height:3.57rem;}
#<?php echo $module['module_name'];?>_html .type .article_type_deep_1 a:hover{  border-bottom:#F30 1px solid;}
