...
#<?php echo $module['module_name'];?>_html .list a{  margin:5px; margin-bottom:0.5rem; display:inline-block;  width:<?php echo $module['sub_module_width'];?>; overflow:hidden; vertical-align:top; text-align:left;  border:1px solid #e7e7e7;}
