<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left save_name="<?php echo $module['module_save_name'];?>"  style="width:100%;" >
    ...
    #<?php echo $module['module_name'];?> .page_list_div .list_head{font-size:1.71rem; height:4.28rem; background-position:top; line-height:4.28rem;   font-weight:bold;background:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['text']?>;}
