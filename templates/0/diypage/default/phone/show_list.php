...
<style>
#<?php echo $module['module_name'];?>{ padding:0px; width:<?php echo $module['module_width'];?>; height:<?php echo $module['module_height'];?>;display:inline-block;vertical-align:top; overflow:hidden;  background:#fff; border:1px solid #e7e7e7;}
#<?php echo $module['module_name'];?>_html{ line-height:50px;}
#<?php echo $module['module_name'];?>_html .module_title{ font-size:1.2rem; height:3.5rem;line-height:3.5rem;  background-position:top;   padding-left:25px;  font-weight:bold;background:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['text']?>;}
...
#<?php echo $module['module_name'];?>_html .list a:hover{ border-bottom:1px solid #F30;}
#<?php echo $module['module_name'];?>_html .list .current_diypage{  border-bottom:1px solid #F30;}
