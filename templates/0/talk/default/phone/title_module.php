...
<style>
#<?php echo $module['module_name'];?>{ width:<?php echo $module['module_width'];?>; height:<?php echo $module['module_height'];?>;display:inline-block;vertical-align:top;position:relative; overflow:hidden;box-shadow:0px 0px 10px rgba(0,0,0,.5); margin:5px; border-radius:10px; border:2px solid #fff;}
...
#<?php echo $module['module_name'];?>_html .list a{ padding-left:1rem; display:block;overflow:hidden; border-bottom:1px dotted #aaa; text-overflow: ellipsis;}
