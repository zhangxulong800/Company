<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <style>
    #<?php echo $module['module_name'];?>{ background:none !important;}
    #<?php echo $module['module_name'];?> .prize{ display:inline-block; vertical-align:top; width:23%; margin:1%; overflow:hidden; line-height:2rem; background:#fff;  padding-bottom:0.5rem;}
    ...
    #<?php echo $module['module_name'];?> .prize .name{ padding-left:0.5rem;padding-right:0.5rem;}
    ...
    #<?php echo $module['module_name'];?> .prize .other{padding-left:0.5rem;padding-right:0.5rem;}
