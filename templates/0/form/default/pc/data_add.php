<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		//$("#<?php echo $module['module_name'];?>").height($(window).height()-<?php echo $module['data']['css_pc_top_int']?>-73);
...
　　					if($(this).prop('value').match(eval(temp))==null){$("#"+$(this).attr('id')+'_state').html('<span class=fail><?php echo self::$language['not_match'];?></span>');$(this).focus();err=true;return false;}
	...
	#<?php echo $module['module_name'];?> .form_title_div{border-bottom:1px solid #ccc; margin-bottom:10px; width:93%;}
