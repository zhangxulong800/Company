...
#<?php echo $module['module_name'];?>_html .module_title{ font-weight:bold;color:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>; text-align:center; display:block; line-height:3rem; font-size:1.1rem;}
