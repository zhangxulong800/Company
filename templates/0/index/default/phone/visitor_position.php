<div id=<?php echo $module['module_name'];?> monxin-module="<?php echo $module['module_name'];?>"  align=left >
    ...
    $(document).ready(function(){
		...
		$("#visitor_position span:first").css('color','#ff9600');
   ...
   #<?php echo $module['module_name'];?>_html #visitor_position{ clear:both; border-bottom:2px solid #ff9600; width:100%; margin:auto; font-weight:bold; padding-bottom:5px; margin-top:10px;  margin-bottom:10px;margin:auto;}
