...
temp=v[0];
	...
	#<?php echo $module['module_name'];?>_html .form_div .f_body #input_div{  margin-left:1rem; margin-right:1rem; border:#CCC 1px solid; text-align:left; padding:0.6rem; border-radius:0.3rem;}
	...
	#<?php echo $module['module_name'];?>_html #login_logo_div{}
	#<?php echo $module['module_name'];?>_html .login_logo_div_a{ text-align:left; margin-left:1rem; margin-right:1rem; border-bottom:1px solid #ccc; margin-bottom:1.5rem;}
	...
	#<?php echo $module['module_name'];?>_html .form_div .f_body .sms_login_div{ border-radius:0.3rem; border: 1px solid #ccc; line-height:2.8rem; margin-bottom:0.3rem; display:none; margin-left:1rem; margin-right:1rem; }
	...
	#<?php echo $module['module_name'];?>_html .form_div .f_body .sms_login_div .sms_div .get_sms_div{ display:inline-block; width:67%; vertical-align:top; overflow:hidden; text-align:right;}
        ...
        <div class=form_div>
        	<div class=f_body>
            	<div id=login_logo_div><img src='logo.png' style="display:none;">
                <div class=login_logo_div_a><a class="password_login current"><?php echo self::$language['password_login'];?></a><a class=sms_login><?php echo self::$language['sms_login'];?></a></div>
                </div>
