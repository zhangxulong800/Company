...
#<?php echo $module['module_name'];?> .nv ul li:hover {background:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>;}
...
#<?php echo $module['module_name'];?> .nv ul ul {line-height:40px;line-height:2.85rem;background:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>; border-radius: 0px; padding: 0;position: absolute; top: 100%;}
...
#<?php echo $module['module_name'];?> #mall_type_all{    display:inline-block; vertical-align:top; width:17.95rem; text-align:left; font-size:18px; margin-right:20px;background:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>; }
