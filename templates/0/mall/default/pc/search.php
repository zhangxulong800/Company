...
#top_layout_out #top_layout_inner #layout_top {white-space: nowrap;}
	...
	#<?php echo $module['module_name'];?>_html .search_input_div{ border:2px <?php echo $_POST['monxin_user_color_set']['nv_1']['background']?>  solid; line-height:38px; height:38px; width:100%; overflow:hidden;}
	...
	#<?php echo $module['module_name'];?>_html .search_input_div .searcch_button{padding: 0px;  display:inline-block; vertical-align:top; width:16%; height:36px; line-height:36px; border-radius:0px; border:0;  text-align:center; background:<?php echo $_POST['monxin_user_color_set']['nv_1']['background']?>; color:<?php echo $_POST['monxin_user_color_set']['nv_1']['text']?>;}
	...
	#<?php echo $module['module_name'];?>_html .search_hot_div a:hover{color:<?php echo $_POST['monxin_user_color_set']['nv_1']['background']?>;}
	...
	#<?php echo $module['module_name'];?>_html .option .option_list span{ display:block;background:<?php echo $_POST['monxin_user_color_set']['nv_2']['background']?>; color:<?php echo $_POST['monxin_user_color_set']['nv_2']['text']?>;padding-left:0.5rem; padding-right:1rem;}
	#<?php echo $module['module_name'];?>_html .option .option_list span:hover{background:<?php echo $_POST['monxin_user_color_set']['nv_3']['background']?>; color:<?php echo $_POST['monxin_user_color_set']['nv_3']['text']?>;}
