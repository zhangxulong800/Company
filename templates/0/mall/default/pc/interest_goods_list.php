...
#<?php echo $module['module_name'];?> { margin-top:5px; white-space:normal; padding:0px;background:none;}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .goods{ display:inline-block; vertical-align:top; vertical-align:top;  width:18.5%; height:19rem;  overflow:hidden;  margin:0.6rem; background:#fff;	}
