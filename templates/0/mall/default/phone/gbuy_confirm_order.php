<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	function set_gbuy_price(){
		if(<?php echo $module['gbuy']?>>0){
			$("#<?php echo $module['module_name'];?> .amount_payable_line .number").html(<?php echo $module['gbuy']?>);
			$("#<?php echo $module['module_name'];?> .sum_money_2 span").html(<?php echo $module['gbuy']?>);
			$("#<?php echo $module['module_name'];?> .subtotal_td .v").html(<?php echo $module['gbuy']?>);
			$("#<?php echo $module['module_name'];?> .favorable_price").html(<?php echo $module['gbuy']?>);
			$("#<?php echo $module['module_name'];?> .price").html(<?php echo $module['gbuy']?>);
			$("#<?php echo $module['module_name'];?> .sum").html(<?php echo $module['gbuy']?>);
    ...
    $(document).ready(function(){
		...
		$("#<?php echo $module['module_name'];?>_html .act_div .submit_now").click(function(){
			...
			$.post('<?php echo $module['action_url'];?>&act=submit&receiver='+receiver+'&delivery_time='+delivery_time+'&authcode='+authcode+'&credits='+$("#<?php echo $module['module_name'];?> .use_web_credits_div .m input").val(),obj, function(data){
				...
				if(v.state=='success'){
					window.location.href='./index.php?monxin=gbuy.pay&id='+v.order_id;
				}
	...
	#<?php echo $module['module_name'];?> .tr .operation_td { line-height:30px; padding-top:<?php echo $module['operation_td_line_height'];?>px; text-align:left; } 
	 ...
	 #<?php echo $module['module_name'];?>_html .shop_div .remark_other .remark{ display:inline-block; vertical-align:top; line-height:1.5rem; width:40%; overflow:hidden; margin-top:3px;}
	...
	#<?php echo $module['module_name'];?> .unit_price_td .price:before {font: normal normal normal 0.9rem/1 FontAwesome;content: "\f157"; padding-right: 1px;}
	...
	#<?php echo $module['module_name'];?>_html .act_div .act_left .sum_money_2 span:before {font: normal normal normal 0.9rem/1 FontAwesome;content: "\f157"; padding-right: 1px;}
	...
	#<?php echo $module['module_name'];?> .credits{ display:none;}
	#<?php echo $module['module_name'];?> .remark_other{ display:none;}
    </style>
    ...
    <?php echo $module['goods_html'];?>
            ...
            <div class="act_div">
            <div class=act_left><a href="./index.php?monxin=mall.my_cart" class="go_cart"></a><div class=sum_money_2><?php echo self::$language['sum_money_2']?>：<span></span></div></div>
