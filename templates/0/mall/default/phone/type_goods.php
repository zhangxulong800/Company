...
temp=old_cart;
	...
	#<?php echo $module['module_name'];?>_html  .goods .price_span{ display:inline-block; vertical-align:top; text-align:left; height:28px; line-height:28px; overflow:hidden;  font-size:0.9rem;padding-left:10px;  width:100%; overflow:hidden; text-overflow: ellipsis;color:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>;}
	#<?php echo $module['module_name'];?>_html  .goods .price_span .money_symbol{ display:none;}
	...
	#<?php echo $module['module_name'];?> .type_list_div .type_0{ font-size:1rem; }
	...
	#<?php echo $module['module_name'];?> .type_list_div .no_scroll{width:108%;overflow:scroll; height:400px;   padding-bottom:2rem;}
