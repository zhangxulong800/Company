<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		if(get_param('monxin')=='' || get_param('monxin')=='index.index'){
			...
			$("#<?php echo $module['module_name'];?> .for_index_search").css('display','none');
		...
		$("#<?php echo $module['module_name'];?> .for_index_search .search_input_span input").focus(function(){
			window.location.href='./index.php?monxin=mall.search';
			return false;
		});
		...
		$("[monxin='mall.search']").click(function(){
			window.location.href='./index.php?monxin=mall.search';
			return false;
		});
    ...
    #<?php echo $module['module_name'];?>_html .search_input_div .search_mall{  margin-right:30px;}
	...
	#<?php echo $module['module_name'];?> .for_index_search .search_input_span{width:67%; overflow:hidden;  border-radius:5px; border:#F6F6F6 solid 1px; background:#fff; height:1.9rem; line-height:1.9rem !important;}
	...
	#<?php echo $module['module_name'];?> .for_index_search .search_input_span input{width:80%;border:none; outline:none;line-height:1.9rem !important;}
	...
	#<?php echo $module['module_name'];?> .show_search_div .top_input_div{  padding:5px; line-height:1.5rem; box-shadow: 0px 2px 5px 2px rgba(0, 0, 0, 0.1);background-color: #F6F6F6; white-space:nowrap;}
	...
	#<?php echo $module['module_name'];?> .show_search_div .top_input_div .input_div select{ display:inline-block; width:25%;border:none; outline:none; padding-left:0.5rem;border:0px; border- margin:5px; text-align:left;}
	#<?php echo $module['module_name'];?> .show_search_div .top_input_div .input_div input{display:inline-block;width:70%;border:none; outline:none; padding-left:0.3rem;}
    ...
    <div class=for_index_search>
    	<span class=logo_span><img src=./phone_logo.png /></span><span class=search_input_span><input type="text" placeholder="<?php echo $module['monxin_search_placeholder']?>" /></span><span class=type_span ><a href=./index.php?monxin=mall.show_type></a></span>
    </div>
    ...
    <div class=show_search_div>
    	<div class=top_input_div>
        	<div class=return_div></div><div class=input_div>
         		...
         		<select class=type><option value="mall.goods_list"><?php echo self::$language['goods'];?></option><option value="mall.shop_list"><?php echo self::$language['shop'];?></option><option value="ci.list">信息</option><option value="article.show_article_list">文章</option></select><input type="text"  class='search'  placeholder="<?php echo $module['monxin_search_placeholder']?>" />
