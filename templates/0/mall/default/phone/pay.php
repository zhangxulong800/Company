...
<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	<style>
    #<?php echo $module['module_name'];?>_html{ padding-left:0.5rem;} 
    #<?php echo $module['module_name'];?>_html .order_info{ margin-bottom:0.3rem; } 
    ...
    #<?php echo $module['module_name'];?>_html .order_info .info{ display:inline-block; vertical-align:top; width:70%; text-align:left; padding-top:0.5rem;} 
    ...
    #<?php echo $module['module_name'];?>_html .order_info .info{ display:inline-block; vertical-align:top;} 
    #<?php echo $module['module_name'];?>_html .title{ padding-left:50px; font-size:40px; font-weight:bold;} 
    #<?php echo $module['module_name'];?>_html .pay_method_option{} 
	...
	#<?php echo $module['module_name'];?>_html .pay_method_body .method_div{ } 
	
	#<?php echo $module['module_name'];?>_html .sub{ line-height:60px; }
	...
	#<?php echo $module['module_name'];?>_html .line .m_label{ display:inline-block; width:30%; text-align:right; padding-right:1%;}
	#<?php echo $module['module_name'];?>_html .line .value{ display:inline-block; width:65%; }
	...
	#<?php echo $module['module_name'];?> .method_div > .sub{ line-height:2rem; }
    ...
    <div id="<?php echo $module['module_name'];?>_html">
        ...
        <div class="portlet-title" style="display:block;"><div class="caption"><?php echo self::$language['please_select'];?><?php echo self::$language['pay_method_str'];?></div></div>
