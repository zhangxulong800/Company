...
function type_module_left_set_next_div(){
	...
	$("#<?php echo $module['module_name'];?>").next('div').css('display','inline-block').css('width',1130).css('overflow','hidden');
}
</script>
<style>
#<?php echo $module['module_name'];?>{ width:200px; height:450px; overflow:hidden; vertical-align:top;  border-top:1px solid #e7e7e7; border-bottom:1px solid #e7e7e7; display:inline-block; vertical-align:top; background-image:url(<?php echo get_template_dir(__FILE__);?>img/type_module_left_bg.png);}
...
#<?php echo $module['module_name'];?>_html .sub_2 .sub_3 a{  display:inline-block; vertical-align:top; width:150px; padding-left:15px; padding-right:15px; height:15px; line-height:15px; height:15px; overflow:hidden;}
