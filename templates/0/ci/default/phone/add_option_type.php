...
.process .current{ border-bottom: #F90 solid 3px;}
</style>
...
#<?php echo $module['module_name'];?>_html .parent_0 .a_hover:after{ margin-top:1rem; font: normal normal normal 1rem/1 FontAwesome; content:"\f0d9"; float:right;color:f9f9f9;background:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['text']?>;}
