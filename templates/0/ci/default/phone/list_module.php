...
margin: 20px 4px;  border:1px solid #e7e7e7; padding:0px;}
#<?php echo $module['module_name'];?>_html{ white-space:nowrap;overflow: hidden;height: 90%;}


#<?php echo $module['module_name'];?>_html .module_title{font-size:1.2rem; height:50px;line-height:50px;  border-bottom:3px solid #F60; padding-right:25px; overflow:hidden;box-shadow:0px 1px 5px #ccc;}
...
#<?php echo $module['module_name'];?>_html .module_title .more{ float:right;}
...
.pad_vertical #<?php echo $module['module_name'];?>_html .list .line .icon { width:20%;}
.pad_vertical #<?php echo $module['module_name'];?>_html .list .line .icon img{ width:90%;max-height:100px;}
