...
<div id=<?php echo $module['module_name'];?>  monxin-module="<?php echo $module['module_name'];?>" align="center">
	...
	$(document).ready(function(){
		...
		$("#go_phone").css('margin-top',($(window).height()-$("#go_phone .modal-content").height())/3);	
...
*/
    ...
    <div class="modal fade" id="go_phone" tabindex="-1" role="dialog"  aria-labelledby="myModalLabel" aria-hidden="true">
       <div class="modal-dialog">
          <div class="modal-content">
             <div class="modal-header">
                <button type="button" class="close" 
                ...
                <h4 class="modal-title" id="myModalLabel">
                   <b><?php echo self::$language['go_phone']?></b>
                </h4>
             </div>
             <div class="modal-body">
             	<?php echo $module['phone_qr'];?>
             </div>
          </div>
    	</div>
    </div>
