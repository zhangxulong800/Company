...
<div id=<?php echo $module['module_name'];?>  monxin-module="<?php echo $module['module_name'];?>" align="center">
	...
	$(document).ready(function(){
		$(document).on('touchstart','.scratch_div',function(e){
			e.stopPropagation(); 
			return false;
		});
		$(document).on('touchend','.scratch_div',function(e){
			e.stopPropagation(); 
			return false;
		});
    ...
    #<?php echo $module['module_name'];?> .scratch_div{}
	...
	.scratch_div{ text-align:center;  -webkit-user-select:none;
