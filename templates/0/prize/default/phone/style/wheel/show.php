...
<div id=<?php echo $module['module_name'];?>  monxin-module="<?php echo $module['module_name'];?>" align="center">
	...
	function  stop_rotate(){
		...
		//$("#<?php echo $module['module_name'];?> .pointer_div").children().attr('style','transform:rotate(45deg); -webkit-transform:rotate(45deg);');
	...
	<style>
	.page-footer{ height:0px; padding:0px;}
	#index_foot,#index_device{ display:none;}
	body,.page-container,.page-content,.container{ margin:0px; padding:0px;}
	.container{ }
    #<?php echo $module['module_name'];?>{ width:100%;background:<?php echo $module['data']['bg_color']?>; background:url(<?php echo $module['data']['phone_bg']?>); background-size:cover; padding-top:<?php echo $module['data']['phone_padding_top']?>;}
	 #<?php echo $module['module_name'];?>_html{}
	  #<?php echo $module['module_name'];?> .wheel_div{height:100%; height:250px; }
	 .pointer_div_out{ position:relative; top:-100%; height:100%;  padding-top:32%; }
   
    #<?php echo $module['module_name'];?> .wheel_img{ width:30%;}
    #<?php echo $module['module_name'];?> .pointer_div{ display:inline-block; width:20%;  }
	...
	.prize_info{  text-align:left; opacity:0.8; }
	.wheel_div{ }
	...
	#<?php echo $module['module_name'];?> .item_name{ border-bottom:1px solid #fff; line-height:25px; margin-bottom:5px;}
	#<?php echo $module['module_name'];?> .prize_winner .item_name{ border:none;}

	
	#<?php echo $module['module_name'];?> .prize_info{ color:#FFF; line-height:20px; }
	...
	#<?php echo $module['module_name'];?> .ad .count_down{ position:absolute;top:0px;right:20px; margin:10px;z-index:9999999999999999; background-color:#F6F; opacity:0.5; padding:5px; color:#FFF; border-radius:5px;}
    </style>
    ...
    <div id="<?php echo $module['module_name'];?>_html" >
        ...
        <div class=over_limit style="display:none;"><?php echo $module['over_limit']?></div>
   		<div class=wheel_div>
        	<div id="pie_container" style="height:250px; " ></div>
        	<div class=pointer_div_out  style="height:250px; "><a href=# class=pointer_div><img class=pointer_img src=<?php echo $module['data']['pc_pointer']?> /></a></div>
        </div>
