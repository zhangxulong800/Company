<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		$("#<?php echo $module['module_name'];?> .exchange").click(function(){
			if(getCookie('monxin_id')!=''){
				id=$(this).attr('d_id');
				if(<?php echo $module['ims']?><parseInt($("#<?php echo $module['module_name'];?> #prize_"+id+" .v").html())){
					alert('<?php echo self::$language['your']?><?php echo self::$language['im']?>:<?php echo $module['ims']?>，<?php echo self::$language['insufficient']?>');
					return false;	
				}
				...
				$.post('<?php echo $module['action_url'];?>&act=exchange',{id:id}, function(data){
					...
					if(v.state=='success'){
						  ...
						  window.location.href='./index.php?monxin=im.my_use';
					}else{
    ...
    #<?php echo $module['module_name'];?> .prize{ display:inline-block; vertical-align:top; width:23%; margin:1%; overflow:hidden; line-height:2rem; }
	#<?php echo $module['module_name'];?> .prize:hover{ opacity:0.9;}
	#<?php echo $module['module_name'];?> .prize .icon_div{ height:270px; overflow:hidden;}
    ...
    #<?php echo $module['module_name'];?> .prize .other .im{ display:inline-block; vertical-align:top; width:50%; overflow:hidden;}
    #<?php echo $module['module_name'];?> .prize .other .im .v{ color:red; padding-left:5px;}
