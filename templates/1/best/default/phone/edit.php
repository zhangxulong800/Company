<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		$("#<?php echo $module['module_name'];?> #type").val('<?php echo $module['data']['type']?>');
		...
		$("#<?php echo $module['module_name'];?> #submit").click(function(){
			...
			$.post('<?php echo $module['action_url'];?>&act=update',{type:type.prop('value'),title:title.prop('value'),link:$("#<?php echo $module['module_name'];?> #link").val(),key:$("#<?php echo $module['module_name'];?> #key").val(),paragraph_title:paragraph_title,paragraph_content:paragraph_content}, function(data){
				v=eval("("+data+")");
    ...
    <div id="<?php echo $module['module_name'];?>_html">
      ...
      <?php echo self::$language['link'];?>：<input type="text"  placeholder="<?php echo self::$language['link_notice']?>" name="link" id="link" value="<?php echo $module['data']['link']?>" /><br /><br />
      <?php echo self::$language['key'];?>：<input type="text"  placeholder="<?php echo self::$language['key_notice']?>" name="key" id="key" value="<?php echo $module['data']['key']?>" /><br /><br />
