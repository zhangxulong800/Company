<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    function update(id){
        ...
        if($("#show_type_"+id).prop('checked')){show_type=1;}else{show_type=0;}
        ...
        $.get('<?php echo $module['action_url'];?>&act=update',{type:type.prop('value'),title:title.prop('value'),sequence:sequence.prop('value'),id:id,visible:visible,show_type:show_type}, function(data){
    ...
    #<?php echo $module['module_name'];?>_table .title{width:220px;}
    ...
    <div class=table_scroll><table class="table table-striped table-bordered table-hover dataTable no-footer"  role="grid"  id="<?php echo $module['module_name'];?>_table" style="width:100%" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <td ><?php echo self::$language['paragraph_show']?></td>
