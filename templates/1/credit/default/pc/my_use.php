<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
        $("#<?php echo $module['module_name'];?> td .submit").click(function(){
			...
			r_info=$("#<?php echo $module['module_name'];?> #tr_"+id+" .r_info").val();
			if(r_info==''){$("#<?php echo $module['module_name'];?> #tr_"+id+" .state").html('<span class=fail><?php echo self::$language['is_null']?></span>');return false;}
			
			$("#<?php echo $module['module_name'];?> #tr_"+id+" .state").html('<span class=\'fa fa-spinner fa-spin\'></span>');
			$.post('<?php echo $module['action_url'];?>&act=update',{id:id,r_info:r_info}, function(data){
	...
	#<?php echo $module['module_name'];?> textarea{ height:100px;}
    </style>
