<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <div id="<?php echo $module['module_name'];?>_html">
    	...
    	<div class=line><span class=m_label><?php echo self::$language['increase']?><?php echo self::$language['amount']?></span><span class=input> <input type="text" class=money value=""  /> <span class=state></span></span></div>        
    	<div class=line><span class=m_label><?php echo self::$language['increase']?><?php echo self::$language['reason']?></span><span class=input> <input type="text" class=reason value=""  /> <span class=state></span></span></div>        
