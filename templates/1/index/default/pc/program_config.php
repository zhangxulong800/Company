<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?>_html .m_label2{ display:inline-block;vertical-align:top; width:48%; padding-right:5px; text-align:right;}
    #<?php echo $module['module_name'];?>_html .m_label{ display:inline-block;vertical-align:top; width:3rem; text-align:right;}
    #<?php echo $module['module_name'];?>_html .content{ width:50%; display:inline-block; display:inline-block; vertical-align:top;}
