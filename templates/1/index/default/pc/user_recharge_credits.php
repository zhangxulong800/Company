<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?>_html .line .input{ line-height:50px; display:inline-block; vertical-align:top; width:70%; overflow:hidden; }
    ...
    <div id="<?php echo $module['module_name'];?>_html">
    	...
    	<div class=line><span class=m_label><?php echo self::$language['recharge']?><?php echo self::$language['credits']?></span><span class=input> <input type="text" class=money value=""  /> <span class=state></span></span></div>        
