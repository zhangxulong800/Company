<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
		...
		$("#<?php echo $module['module_name'];?> .exe_import").click(function(){
			...
			$.post("<?php echo $module['action_url'];?>&act=import",{field_set:$("#<?php echo $module['module_name'];?> .field_set").val(),import_file:$("#<?php echo $module['module_name'];?> #import_file").val()},function(data){
				...
				if(v.state=='fail'){
					...
					$("#<?php echo $module['module_name'];?> .exe_import").next('span').html(v.info+' <a href=./index.php?monxin=index.admin_users><?php echo self::$language['refresh']?></a>');
				}
			});	
	...
	#<?php echo $module['module_name'];?>_html .m_label{ width:140px; display:inline-block; text-align:right; padding-right:5px; margin-bottom:20px;}
	#<?php echo $module['module_name'];?>_html .option{ width:820px; display:inline-block;}
	...
	#<?php echo $module['module_name'];?> .show_more_option{ margin-left:20px; font-size:15px; line-height:100%;   }
    ...
    #<?php echo $module['module_name'];?>_table .icon img{ width:5rem; height:5rem;}
    ...
    <div class="portlet-title">
        ...
        <div class="actions">
        	...
        	&nbsp; <a href=./index.php?monxin=index.user_map class=user_map><?php echo self::$language['pages']['index.user_map']['name']?></a>
            ...
            &nbsp; <a  href=./index.php?monxin=index.id_increase_user class="add increase_user"><?php echo self::$language['pages']['index.id_increase_user']['name']?></a>
    ...
    <div class="m_row"><div class="half"><div class="dataTables_length"><select class="form-control" id="page_size" ><option value="10">10</option><option value="20">20</option><option value="50">50</option><option value="100">100</option></select> <?php echo self::$language['per_page']?></m_label></div></div><div class="half">
