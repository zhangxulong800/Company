...
.page-header-top .container .page-logo{ display:block; text-align:center; background:rgba(33,50,66,1);}
...
.page-header-top .top-menu a{color:#7089a2;}
...
.page-header-top .top-menu > ul li li:hover{background:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?> !important;   }
.page-header-top .top-menu > ul li li:hover a{ color:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['text']?> !important; }
...
.search_div{ padding-left:1rem;line-height:25px; height:25px;}
.search_div .search{ width:85%; line-height:25px; height:25px;}
.search_div .search_button{ display:inline-block; vertical-align:top; width:25%; background-color:rgba(108,125,143,1); color:#fff; text-align:center; font-size:0.9rem; cursor:pointer; display:none;}
...
<div class="page-header-top">
    ...
    <div class=search_div><input type="text" class=search placeholder="<?php echo self::$language['search']?>" /><a class=search_button><?php echo self::$language['search']?></a></div>
...
#<?php echo $module['module_name'];?>  { text-align:left; background:rgba(52,73,94,1);}
...
#<?php echo $module['module_name'];?> .nv ul li{ line-height:3rem;padding-left:1rem;}
#<?php echo $module['module_name'];?> .nv ul  ul {display: none; position:absolute; left:150px; width:600px; max-height:60%;  white-space:normal; background:rgba(75,149,197,1); color:#fff; overflow:scroll; overflow-x:hidden; z-index:999;    box-shadow: 2px 1px 2px 2px rgba(0, 0, 0, 0.1); }
...
#<?php echo $module['module_name'];?> .nv ul li:hover{background:rgba(75,149,197,1); }
#<?php echo $module['module_name'];?> .nv ul li:hover >a{ opacity:1; }
#<?php echo $module['module_name'];?> .nv ul li:hover > ul {display: block;}
#<?php echo $module['module_name'];?> .nv ul  ul>li:hover > a >span{ color:rgba(217,168,83,1);}
...
#<?php echo $module['module_name'];?> .search_result_div a:hover{ background:rgba(75,149,197,1); color:#fff;}
