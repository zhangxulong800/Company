<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
        ...
        $("#submit").click(function(){
            ...
            $("#submit_state").load('<?php echo $module['action_url'];?>&act=submit',json,function(){
                if($(this).html().length>10){
					...
					if(v.state=='success'){
						$(this).html(v.info+" <a href='./index.php?monxin=index.money_transfer_log'><?php echo self::$language['view']?></a>");
					}else{
	...
	#<?php echo $module['module_name'];?>_html input{ height:30px; line-height:30px; padding-left:5px; width:60%;}
    ...
    <tr ><td width="40%" align="right"><span><?php echo self::$language['user_money'];?></span></td>
    <td width="60%"><?php echo $module['user_money'];?></td></tr>
