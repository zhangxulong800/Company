<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
  ...
  <li role="presentation" class="active"><a href="./index.php?monxin=index.foot_edit&type=pc"><?php echo self::$language['pc_device'];?></a></li>
  <li role="presentation"><a href="./index.php?monxin=index.foot_edit&type=phone"><?php echo self::$language['phone_device'];?></a></li>
</ul>
