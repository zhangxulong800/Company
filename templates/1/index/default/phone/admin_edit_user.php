...
<script src="./plugin/datePicker/index.php"></script>
    ...
    <div class=table_scroll><table border="0" cellpadding="0" cellspacing="0" id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left _table style="width:100%;">
