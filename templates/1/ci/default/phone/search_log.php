<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?> .hot_search{width:60%;}
    #<?php echo $module['module_name'];?> .keyword{ text-align:left; width:100px;}
    </style>
    ...
    <div class="filter"><?php echo self::$language['hot_search']?>: <input type="text" class=hot_search value="<?php echo $module['hot_search'];?>" /> <a href="#" class="submit"><?php echo self::$language['submit']?></a> <span></span> 
    </div>
    <div class=table_scroll><table class="table table-striped table-bordered table-hover dataTable no-footer"  role="grid"  id="<?php echo $module['module_name'];?>_table" style="width:100%" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                <td width="3%"><input type="checkbox" group-checkable=1></td>
