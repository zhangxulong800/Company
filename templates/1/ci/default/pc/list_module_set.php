<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    $(document).ready(function(){
		...
		$("#<?php echo $module['module_name'];?> #submit").click(function(){
			...
			args+='|'+'img_link:'+$("#<?php echo $module['module_name'];?> #img_link").val().replace(/\./g,'*').replace(/:/g,'!').replace(/#/g,'');
			...
			args+='|'+'i_width:'+$("#<?php echo $module['module_name'];?> #i_width").val();
			args=args.replace(/\|/,'');
    ...
    #<?php echo $module['module_name'];?> .m_label{ display:inline-block; padding-right: 10px;box-shadow: none;width:20%; text-align:right; padding-right:10px;}
    #<?php echo $module['module_name'];?> .input_span{ display:inline-block; vertical-align:top; width:70%; overflow:hidden;}
    #<?php echo $module['module_name'];?> .input_span input {height:40px; line-height:40px; }
	...
	#<?php echo $module['module_name'];?> .input_checkbox{ display:inline-block; vertical-align:top; margin-top:25px;;}
    </style>
    <div id="<?php echo $module['module_name'];?>_html">
        <div class="portlet-title">
   	  ...
   	  <div><span class="m_label"><?php echo self::$language['default'];?><?php echo self::$language['module'];?><?php echo self::$language['title'];?></span><span class=input_span>
   	  ...
   	  <div><span class="m_label"><?php echo self::$language['default'];?><?php echo self::$language['data_src'];?></span><span class=input_span>
   	  ...
   	  <div><span class="m_label"><?php echo self::$language['single_information_width'];?></span><span class=input_span>
      		<input type="text" id="i_width" name="i_width" value="<?php echo $module['i_width'];?>" /> <span></span> 
      </span></div> 
