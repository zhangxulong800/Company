<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		$("#<?php echo $module['module_name'];?> #submit").click(function(){
			...
			$.post('<?php echo $module['action_url'];?>&act=add',{name: j_name.val(),placeholder:$("#placeholder").val(),required:$("#required").val(),unique:$("#unique").val(),search_able:$("#search_able").val(),reg:$("#reg").val(),input_type:$("#input_type").val(),postfix:$("#postfix").val(),args:args} ,function(data){
				//alert(data);	
    ...
    <div id=<?php echo $module['module_name'];?>_html>
    	<div><span class=m_label><span class=required_item>*</span><?php echo self::$language['attribute'];?><?php echo self::$language['name'];?></span><span class=input_span><input type="text" id="name" /><span></span></span></div>       
    	...
    	<div><span class=m_label><?php echo self::$language['attribute_postfix'];?></span><span class=input_span><input type="text" id="postfix" placeholder="<?php echo self::$language['optional'];?> <?php echo self::$language['example']?>㎡、㎞、㎏、元"  /><span></span></span></div>     
