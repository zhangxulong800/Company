    ...
    <div id=<?php echo $module['module_name'];?>_html>
        ...
        <div id=args_div>
        	<div id=args_text class=args>
            	...
            	<div><span class=m_label><?php echo self::$language['default_value'];?></span><span class=input_span><input type="text" id="text_default_value"   placeholder="<?php echo self::$language['user_last_value']?>"  /><span></span></span></div>
            </div>
        	...
        	<div id=args_textarea class=args>
            	...
            	<div><span class=m_label><?php echo self::$language['default_value'];?></span><span class=input_span><textarea id="textarea_default_value"   placeholder="<?php echo self::$language['user_last_value']?>" ><?php echo @$module['args']['textarea_default_value']?></textarea><span></span></span></div>
        	...
        	<div id=args_editor class=args>
            	...
            	<div><span class=m_label><?php echo self::$language['default_value'];?></span><span class=input_span><textarea id="editor_default_value"   placeholder="<?php echo self::$language['user_last_value']?>" ></textarea><span></span></span></div>
        	...
        	<div id=args_select class=args>
            	...
            	<div><span class=m_label><?php echo self::$language['default_value'];?></span><span class=input_span><input type="text" id="select_default_value"  placeholder="<?php echo self::$language['user_last_value']?>" /><span></span></span></div>
            </div>
        	...
        	<div id=args_radio class=args>
            	...
            	<div><span class=m_label><?php echo self::$language['default_value'];?></span><span class=input_span><input type="text" id="radio_default_value"   placeholder="<?php echo self::$language['user_last_value']?>" /><span></span></span></div>
            </div>
        	...
        	<div id=args_checkbox class=args>
            	...
            	<div><span class=m_label><?php echo self::$language['default_value'];?></span><span class=input_span><input type="text" id="checkbox_default_value"   placeholder="<?php echo self::$language['user_last_value']?>"  /><span></span></span></div>
            </div>
        	...
        	<div id=args_number class=args>
            	...
            	<div><span class=m_label><?php echo self::$language['default_value'];?></span><span class=input_span><input type="text" id="number_default_value"   placeholder="<?php echo self::$language['user_last_value']?>"  /><span></span></span></div>
            </div>
