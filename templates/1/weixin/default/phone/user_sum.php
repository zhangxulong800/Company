<div id=<?php echo $module['module_name'];?>  class="portlet light sum_card" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?> .card_head{background-color: #9999FF; }
	
    </style>
    
    <div id=<?php echo $module['module_name'];?>_html>
    	<a href="./index.php?monxin=weixin.account_list" class=card_head>
        	<span class=big_num><?php echo $module['sum'];?></span>
            <span class=remark><?php echo self::$language['pages']['weixin.account_list']['name'];?></span>
        </a>
    	<div class=card_body>
        	<a href='./index.php?monxin=weixin.account_list' class=item>
            	<span class=name><?php echo self::$language['user']?></span>
            	<span class=value><?php echo $module['user'];?></span>
            </a><a href='./index.php?monxin=weixin.account_list' class=item>
