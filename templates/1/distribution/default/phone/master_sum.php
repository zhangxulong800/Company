<div id=<?php echo $module['module_name'];?>  class="portlet light sum_card" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <div id=<?php echo $module['module_name'];?>_html>
    	<a href="./index.php?monxin=distribution.goods_admin&current_page=1&order=state|asc" class=card_head>
        	<span class=big_num><?php echo $module['goods_state_0'];?></span>
            <span class=remark><?php echo self::$language['goods_state_option'][0];?><?php echo self::$language['distribution'];?><?php echo self::$language['goods'];?></span>
        </a>
    	<div class=card_body>
        	<a  class=item>
            ...
            </a><a href='./index.php?monxin=distribution.shop_admin' class=item>
            ...
            </a><a href='./index.php?monxin=distribution.order_admin' class=item>
