<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    function add(){
        ...
        $.get('<?php echo $module['action_url'];?>&act=add',{dir:dirNew.prop('value'),name:nameNew.prop('value'),sequence:sequenceNew.prop('value')}, function(data){
            //alert(data);
    ...
    function update(id){
        ...
        $.get('<?php echo $module['action_url'];?>&act=update',{dir:dir.prop('value'),name:name.prop('value'),sequence:sequence.prop('value'),id:id,state:state}, function(data){
           //alert(data);
            try{v=eval("("+data+")");}catch(exception){alert(data);}
