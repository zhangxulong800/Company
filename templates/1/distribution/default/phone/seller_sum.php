<div id=<?php echo $module['module_name'];?>  class="portlet light sum_card" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <div id=<?php echo $module['module_name'];?>_html>
    	<a href="./index.php?monxin=distribution.shop_order" class=card_head>
        	<span class=big_num><?php echo $module['today_orders'];?></span>
            <span class=remark><?php echo self::$language['today'];?><?php echo self::$language['distribution'];?><?php echo self::$language['orders'];?></span>
        </a>
    	<div class=card_body>
        	<a  class=item>
            ...
            </a><a href='./index.php?monxin=distribution.shop_shop' class=item>
            ...
            </a><a href='./index.php?monxin=distribution.shop_order' class=item>
