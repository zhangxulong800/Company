<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	.monxin_dir_tree{ border:0px; margin:0px; padding-left:1rem; margin-top:1rem;}
    ...
    #<?php echo $module['module_name'];?> .monxin_dir_tree .level_0 >div >img{ height:3rem; width:3rem; border-radius:1.5rem;}
