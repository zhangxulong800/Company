<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    $(document).ready(function(){
		if('<?php echo $module['distribution_mode']?>'==0){
    ...
    <div id="<?php echo $module['module_name'];?>_html" monxin-table=1>
		<div class="alert alert-success" role="alert"><?php echo $module['distribution_remark'];?></div>
        
        <div class="portlet-title">
            <div class="caption"><?php echo self::$language['pages']['distribution.shop_goods']['name']?></div>
            <div class="actions"><a href=./index.php?monxin=mall.goods_admin&act=distribution class=increase><?php echo self::$language['increase'];?></a></div>
        </div>
    ...
    <div class=table_scroll><table class="table table-striped table-bordered table-hover dataTable no-footer"  role="grid"  id="<?php echo $module['module_name'];?>_table" style="width:100%" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <td ><a href=# title="<?php echo self::$language['order']?>" desc="distribution_shop|desc" class="sorting"  asc="distribution_shop|asc"><?php echo self::$language['distribution_shop']?></a></td>
                <td ><a href=# title="<?php echo self::$language['order']?>" desc="distribution_sold|desc" class="sorting"  asc="distribution_sold|asc"><?php echo self::$language['distribution_sold']?></a></td>
