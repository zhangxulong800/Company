<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?>_html .line .m_label{ display:inline-block; vertical-align: top; width:30%; text-align:right; padding-right:10px; box-shadow:none;} 
    #<?php echo $module['module_name'];?>_html .line .value{ display:inline-block; vertical-align:top; width:70%;  vertical-align:top; white-space: normal;} 
    ...
    <div id="<?php echo $module['module_name'];?>_html">
       <div class="portlet-title">
    	...
    	<div class=line><span class=m_label><?php echo self::$language['g_price'];?>：</span><span class=value><input type="text" id=price value="<?php echo $module['data']['price'];?>" /> <span class=state></span></span></div>
        
    	<div class=line><span class=m_label><?php echo self::$language['g_number'];?>：</span><span class=value><input type="text" id=number value="<?php echo $module['data']['number'];?>" /> <span class=state></span></span></div>
    	...
    	<div class=line><span class=m_label><?php echo self::$language['g_earn'];?>：</span><span class=value><input type="text" id=earn value="<?php echo $module['data']['earn'];?>" /> <span class=state></span></span></div>
