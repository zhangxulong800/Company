<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		$("#index_user_position a[href='index.php?monxin=form.table_edit']").attr('href','index.php?monxin=form.table_edit&id=<?php echo $module['data']['table_id'];?>');
		...
		$("#<?php echo $module['module_name'];?> #submit").click(function(){
			...
			$.post('<?php echo $module['action_url'];?>&act=update',{ description:j_description.val(), name: j_name.val(),placeholder:$("#placeholder").val(),required:$("#required").val(),unique:$("#unique").val(),search_able:$("#search_able").val(),reg:$("#reg").val(),input_type:$("#input_type").val(),args:args} ,function(data){
                ...
                if(v.state=='success'){
                	...
                	window.location.href='./index.php?monxin=form.table_edit&id='+v.table_id;
                }
