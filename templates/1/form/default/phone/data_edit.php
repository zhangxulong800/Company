...
　　					if($(this).prop('value').match(eval(temp))==null){$("#"+$(this).attr('id')+'_state').html('<span class=fail><?php echo self::$language['not_match'];?></span>');$(this).focus();err=true;return false;}
    ...
    #<?php echo $module['module_name'];?> .required{ }
    #<?php echo $module['module_name'];?> div{ line-height:100px;}
    #<?php echo $module['module_name'];?> .m_label{ display:inline-block; width:20%; text-align:right; overflow:hidden; padding-right:10px;}
    #<?php echo $module['module_name'];?> .input_span{ display:inline-block; width:70%; overflow:hidden;}
	#<?php echo $module['module_name'];?> .input_span input{ width:90%;}
