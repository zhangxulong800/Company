<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <style>
    #<?php echo $module['module_name'];?>_table .parent{ float:left;  width:100px; overflow:hidden;}
    #<?php echo $module['module_name'];?>_table .name{float:right;width:80px;}
    #<?php echo $module['module_name'];?>_table .sequence{width:40px;}
    #<?php echo $module['module_name'];?>_table .manager{width:100px;}
