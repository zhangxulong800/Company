<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    <div id="<?php echo $module['module_name'];?>_html">
    	...
    	<div class=line><span class=m_label><?php echo self::$language['shop_icon'];?></span><span class=input_span> <span class=state id=icon_state></span><a href="./program/mall/shop_icon/<?php echo $module['id']?>.png"  target="_blank"><img src="./program/agency/shop_icon/<?php echo $module['icon']?>" class=icon_img /></a></span></div>
        
		<hr />
        
    	<div class=line><span class=m_label><?php echo self::$language['shop_banner'];?></span><span class=input_span> <span class=state id=banner_state></span><a href="./program/mall/shop_icon/<?php echo $module['id']?>.png"  target="_blank"><img src="./program/agency/banner/<?php echo $module['banner']?>" class=banner_img /></a></span></div>
