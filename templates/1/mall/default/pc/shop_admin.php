<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?> .shops >div .s_left{ display:inline-block; vertical-align:top; width:17%; overflow:hidden; line-height:2rem;}
	#<?php echo $module['module_name'];?> .shops >div .s_left img{ width:80%;}
	#<?php echo $module['module_name'];?> .shops >div .s_right{ color:rgba(33,32,32,1.00); display:inline-block; vertical-align:top; width:83%; overflow:hidden;}
	#<?php echo $module['module_name'];?> .shops >div .s_right a{ color:rgba(33,32,32,1.00);}
	#<?php echo $module['module_name'];?> .shops >div .s_left .icon_logo{ display:block; width:100%; text-align:center; font-weight:bold;}
	#<?php echo $module['module_name'];?> .shops >div .s_left .name{ display:block; width:100%; text-align:center; font-weight:bold;}
	...
	#<?php echo $module['module_name'];?> .c_txt{ border-radius:3px; border:1px dashed #ccc; display:inline-block; vertical-align:top; padding-left:5px; background:rgba(250,250,250,1.00);}
    </style>
