<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    <ul class="nav nav-tabs">
      <li role="presentation" class="active"><a href="./index.php?monxin=mall.diypage_edit&id=<?php echo $_GET['id']?>&type=pc"><?php echo self::$language['pc_device'];?></a></li>
      <li role="presentation"><a href="./index.php?monxin=mall.diypage_edit&id=<?php echo $_GET['id']?>&type=phone"><?php echo self::$language['phone_device'];?></a></li>
	</ul>
