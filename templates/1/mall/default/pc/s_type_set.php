<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?>_html .next_disable{ display:inline-block; vertical-align:top; height:80px; width:440px; line-height:80px; background-repeat:no-repeat; margin-left:auto; margin-right:auto; font-size:30px;background-color:#ccc; }
	#<?php echo $module['module_name'];?>_html .next_disable:hover{}
	#<?php echo $module['module_name'];?>_html .next_able{ display:inline-block; vertical-align:top; height:80px; width:440px; line-height:80px; background-repeat:no-repeat; margin-left:auto; margin-right:auto; font-size:30px;background:<?php echo $_POST['monxin_user_color_set']['button']['background']?>;color:<?php echo $_POST['monxin_user_color_set']['button']['text']?>;  }
    ...
    <div di=div_1 class=class_div>
        ...
        <select id=select_1 name=select_1 size="30" monxin_value='<?php echo $module['class_1_value'];?>' ><?php echo $module['class_1'];?></select>
    </div>
    <div di=div_2 class=class_div>
    	<div class=title><?php echo self::$language['class_2'];?></div>
        <select id=select_2 name=select_2 size="30" monxin_value='<?php echo $module['class_2_value'];?>' ><?php echo $module['class_2'];?></select>
    </div>
    <div di=div_3 class=class_div>
    	<div class=title><?php echo self::$language['class_3'];?></div>
        <select id=select_3 name=select_3 size="30" monxin_value='<?php echo $module['class_3_value'];?>' ><?php echo $module['class_3'];?></select>
    </div>
	
    <div id=next_div><a href=# id=next_button class=next_disable type=0><span class=s>&nbsp;</span><span class=m><?php echo self::$language['save'];?></span><span class=e>&nbsp;</span></a></div>
