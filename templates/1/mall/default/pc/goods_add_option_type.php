<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?>_html .next_able{   border-radius:40px; display:inline-block; vertical-align:top; height:4rem; width:440px; line-height:4rem; background-repeat:no-repeat; margin-left:auto; margin-right:auto; font-size:2rem;background:<?php echo $_POST['monxin_user_color_set']['button']['background']?>;color:<?php echo $_POST['monxin_user_color_set']['button']['text']?>; }
