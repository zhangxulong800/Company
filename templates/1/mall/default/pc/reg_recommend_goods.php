<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    function update(id){
        ...
        $.get('<?php echo $module['action_url'];?>&act=update',{id:id,introducer_rate:$("#introducer_rate_"+id).val()}, function(data){
            //alert(data);
    ...
    function subimt_select(){
        ...
        for(id in ids){
            ...
            obj[id]=new Object();
            obj[id]['id']=ids[id];
            obj[id]['introducer_rate']=$("#<?php echo $module['module_name'];?> #introducer_rate_"+ids[id]).prop('value');
    ...
    #<?php echo $module['module_name'];?> .introducer_rate{ width:3rem; text-align:center;}
    </style>
    ...
    <div class=table_scroll><table class="table table-striped table-bordered table-hover dataTable no-footer"  role="grid"  id="<?php echo $module['module_name'];?>_table" style="width:100%" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <td ><?php echo self::$language['introducer_rate']?></td>
