<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?> .goods_info{line-height:2rem; display:block; width:350px; overflow:hidden; white-space:nowrap;     text-overflow: ellipsis;}
    ...
    <div class="portlet-title">
        ...
        <div class="actions"><input type="search"  placeholder="<?php echo self::$language['please_input']?><?php echo self::$language['order_number']?>/<?php echo self::$language['buyer'] ?>/<?php echo self::$language['reason'] ?>" class="form-control" style="width:200px;" ></div>
    </div>
    ...
    <div class=table_scroll><table class="table table-striped table-bordered table-hover dataTable no-footer"  role="grid"  id="<?php echo $module['module_name'];?>_table" style="width:100%" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <td><?php echo self::$language['return_goods']?><?php echo self::$language['quantity']?></td>
                <td><?php echo self::$language['buyer']?></td>
                <td><?php echo self::$language['operator']?></td>
                <td><?php echo self::$language['order_number']?></td>
