<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?> .p_group{ display:inline-block; vertical-align:top; width:30%; margin-right:1%; margin-bottom:10px;  height:200px; text-align:center; border:1px dashed #ccc; padding:10px; white-space:nowrap;}
	...
	#<?php echo $module['module_name'];?> .p_group b{ display:none; font-weight:normal; background-color:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['text']?>; border-radius:3px; padding-left:3px; padding-right:3px;}
