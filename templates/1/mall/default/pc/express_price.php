<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?>_html .show_sub:before {content: "\f107";margin-left: 2px;    font-family: "FontAwesome";}
	#<?php echo $module['module_name'];?>_html .area_a a{}
	#<?php echo $module['module_name'];?>_html .area_a a:after {content: "\f105";margin-left: 5px; margin-right: 5px;    font-family: "FontAwesome";}
    </style>
	<div id="<?php echo $module['module_name'];?>_html"  monxin-table=1>
    <div class=area_a><?php echo self::$language['area_s']?>:<a href=./index.php?monxin=mall.express_price&id=<?php echo $_GET['id']?>><?php echo  self::$language['all']?></a><?php echo $module['area_a_position'];?></div>
