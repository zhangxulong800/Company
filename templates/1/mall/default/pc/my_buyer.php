<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?>_html .chip{ width:50px;	}
	#<?php echo $module['module_name'];?>_html .chip{ width:50px;	}
	.username:hover{ font-weight:bold;}
    </style>
    ...
    <div class="portlet-title">
        ...
        <div class="actions">
            ...
            <a  href=./index.php?monxin=mall.id_increase_user class="add increase_user"><?php echo self::$language['pages']['mall.id_increase_user']['name']?></a>
