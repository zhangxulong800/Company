<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?>_html .add_symbol:before{font: normal normal normal 3rem/1 FontAwesome; content:"\f067"; height:15.6rem; line-height:15.6rem;}
	...
	#<?php echo $module['module_name'];?>_html .result_div{ display:inline-block; vertical-align:top;vertical-align: middle;width:18%; margin-bottom:1rem; overflow:hidden; margin:10px; text-align:left;  border:2px solid #ddd; padding:20px;} 
    #<?php echo $module['module_name'];?>_html .goods_div{ display:inline-block; vertical-align:top; width:18%; margin-bottom:1rem; margin-right:1%; vertical-align:top; overflow:hidden; line-height:2rem; height:18.2rem;  text-align:center;  padding:10px; border:4px solid #ddd;}
	...
	#<?php echo $module['module_name'];?>_html #new{ width:100%;}
	#<?php echo $module['module_name'];?>_html #add{ display:inline-block; border:none; padding:0;width:18%; margin-bottom:1rem; }
	#<?php echo $module['module_name'];?>_html #add:before{	font: normal normal normal 55px/1 FontAwesome;	line-height:250px;	content: "\f067";}
