<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		$('.icon').click(function(){
			...
			$("#monxin_iframe").attr('src','index.php?monxin=index.replace_file&path='+replace_file+'&width=246&height=100');
			return false;	
		});
    ...
    function add(){
        ...
        $.get('<?php echo $module['action_url'];?>&act=add',{parent:parent_idNew.prop('value'),name:nameNew.prop('value'),url:urlNew.prop('value'),sequence:sequenceNew.prop('value'),visible:visible}, function(data){
    ...
    function update(id){
        parent=$("#<?php echo $module['module_name'];?> #parent_"+id);
...
$.get('<?php echo $module['action_url'];?>&act=del',{id:id}, function(data){
    ...
    #<?php echo $module['module_name'];?> .name{float:right; width:300px;}
	...
	#<?php echo $module['module_name'];?> .icon{}
	#<?php echo $module['module_name'];?> .icon img{ width:128px; height:64px;  border:0px;}
    ...
    <div class=table_scroll><table class="table table-striped table-bordered table-hover dataTable no-footer"  role="grid"   id="<?php echo $module['module_name'];?>_table_a" style="width:100%" cellspacing="0">
        <thead>
            <tr>
                ...
                <td width="10%"><?php echo self::$language['brand_icon']?></td>
                <td width="18%"><?php echo self::$language['type_icon']?></td>
