<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left  >
	...
	#<?php echo $module['module_name'];?>_html .is_annual{ line-height:100px; height:100px; text-align:center; font-size:20px;}
	#<?php echo $module['module_name'];?>_html .is_annual .open_annual{ display:inline-block; vertical-align:top; border-radius:15px;   height:40px; line-height:40px; margin-top:30px; padding-left:10px; padding-right:10px;}
