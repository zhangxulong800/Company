...
$.get('<?php echo $module['action_url'];?>&act=del',{id:id}, function(data){
    ...
    <div class="filter">
    	...
    	<span class=m_label><?php echo self::$language['image'];?></span><span id=img_temp></span><span class=m_label><?php echo self::$language['name'];?></span><input id=name_new name=name_new /> &nbsp;  &nbsp;  &nbsp;<span class=m_label><?php echo self::$language['url'];?></span><input id=url_new name=url_new /> <a href="#" onclick="return add()"  class='add'><?php echo self::$language['add']?></a> <span id=state_new  class='state'></span>
    </div>
