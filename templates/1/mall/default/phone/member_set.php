<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left  >
	...
	#<?php echo $module['module_name'];?>_html .line .m_label{ display:block; }
	#<?php echo $module['module_name'];?>_html .line .input_span{display:block;}
    ...
    <div class="portlet-title">
    	...
    	<div class=line><span class=m_label style="display:none;">&nbsp;</span><span class=input_span><a href=# class=submit><?php echo self::$language['submit']?></a> <span class=state></span></span></div>
