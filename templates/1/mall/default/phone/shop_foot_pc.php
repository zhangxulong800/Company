<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <ul class="nav nav-tabs">
      <li role="presentation" class="active"><a href="./index.php?monxin=mall.shop_foot&type=pc"><?php echo self::$language['pc_device'];?></a></li>
      <li role="presentation"><a href="./index.php?monxin=mall.shop_foot&type=phone"><?php echo self::$language['phone_device'];?></a></li>
	</ul>
    <form id="monxin_form" name="monxin_form" method="POST" action="<?php echo $module['action_url'];?>" onSubmit="return exe_check();">
    <textarea name="content" id="content" style="display:none; width:100%; height:400px;"><?php echo $module['foot_pc']?></textarea>
