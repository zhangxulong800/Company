<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?>{ margin:1rem; overflow:scroll; line-height:3rem;}
    #<?php echo $module['module_name'];?>_html{}
    #<?php echo $module['module_name'];?>_html .tags{ }
    #<?php echo $module['module_name'];?>_html .tags span{ display:inline-block; vertical-align:top; margin-right:20px;}
    #<?php echo $module['module_name'];?>_html .tags span input{ }
    </style>
