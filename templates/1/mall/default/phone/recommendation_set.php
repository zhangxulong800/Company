<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    #<?php echo $module['module_name'];?>_html .goods_div .goods{ display:block; vertical-align:top;  margin-bottom:1rem; margin-right:1%; vertical-align:top; overflow:hidden; line-height:2rem; text-align:center;  padding:10px; border:4px solid #ddd;	}
