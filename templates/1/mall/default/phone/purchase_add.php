<div id=<?php echo $module['module_name'];?>  class="portlet light"  monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	<style>
    #<?php echo $module['module_name'];?>{}
    #<?php echo $module['module_name'];?> .line{ line-height:2rem;}
    ...
    <div id="<?php echo $module['module_name'];?>_html"  monxin-table=1>
    	...
    	<div class=line id=bar_code_div><span class=m_label><?php echo self::$language['barcode']?>/<?php echo self::$language['store_code']?>:</span><span class=m_value><input type="text" class=bar_code id=bar_code_input /> <span class=state></span> <a href=./index.php?monxin=mall.stock class=or_link_into><?php echo self::$language['or_link_into']?></a></span></div>
