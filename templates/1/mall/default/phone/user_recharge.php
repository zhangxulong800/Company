<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
        ...
        $("#<?php echo $module['module_name'];?> .submit").click(function(){
			...
			$.post('<?php echo $module['action_url'];?>&act=add',obj, function(data){
				...
				if(v.state=='success'){
					...
					parent.update_balance(<?php echo @$_GET['id']?>,$("#<?php echo $module['module_name'];?> .money").val());	
				}
	...
	#<?php echo $module['module_name'];?>_html .line .m_label{ text-align:right; width:20%; display:inline-block; vertical-align:top;}
