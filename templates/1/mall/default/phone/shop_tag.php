    ...
    <div class=table_scroll><table class="table table-striped table-bordered table-hover dataTable no-footer"  role="grid" style="width:100%" cellpadding="0" cellspacing="0">
         <thead>
            <tr>
                ...
                <td><?php echo self::$language['shop_tag_rate']?></td>
                <td><?php echo self::$language['annual_shop_tag_rate']?></td>
        ...
        <tbody>
            ...
            <tr id="<?php echo $module['module_name'];?>_new">
              ...
              <td ><input type="text" name="rate_new" id="rate_new" class='rate' /> %</td>
              <td ><input type="text" name="annual_rate_new" id="annual_rate_new" class='annual_rate' /> %</td>
