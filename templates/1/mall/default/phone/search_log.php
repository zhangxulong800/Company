<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <div class="filter">
		<?php echo self::$language['hot_search']?>: <input type="text" class=hot_search value="<?php echo $module['hot_search'];?>" /> <a href="#" class="submit"><?php echo self::$language['submit']?></a> <span></span> 
    </div>
