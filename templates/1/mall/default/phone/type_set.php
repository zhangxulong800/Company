<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?>_html .next_disable{  border-radius:40px; display:inline-block; vertical-align:top; height:80px; width:440px; line-height:80px; background-repeat:no-repeat; margin-left:auto; margin-right:auto; font-size:30px;background-color:#ccc; }
