<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?> .goods_div .comment .user{background-image:url(<?php echo get_template_dir(__FILE__);?>img/comment_user_bg.png); background-repeat:no-repeat; display:inline-block; width:100px; padding-left:12px; text-align:left;}
	...
	#<?php echo $module['module_name'];?> .goods_div .comment .content .edit{background-image:url(<?php echo get_template_dir(__FILE__);?>img/comment_edit.png); background-repeat:no-repeat; width:50px; height:50px; display:inline-block;}
	#<?php echo $module['module_name'];?> .goods_div .comment .content .del{background-image:url(<?php echo get_template_dir(__FILE__);?>img/comment_del.png); background-repeat:no-repeat; width:50px; height:50px; display:inline-block;}
