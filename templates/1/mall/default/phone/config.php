<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?>_html .line .value{ display:inline-block; vertical-align: middle; width:30%;}
	#<?php echo $module['module_name'];?>_html .line .value input { width:60%; text-align: right;}
    </style>    
