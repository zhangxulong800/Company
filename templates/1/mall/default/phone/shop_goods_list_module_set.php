<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left  >
	...
	#<?php echo $module['module_name'];?>_html #img_file_ele{ vertical-align: middle; }
    ...
    #<?php echo $module['module_name'];?> .m_label{ display:inline-block; vertical-align:top; width:300px; text-align:right; padding-right:10px; box-shadow: none; vertical-align: middle;}
	...
	#<?php echo $module['module_name'];?> .checker+span { vertical-align:middle;} 
    </style>
