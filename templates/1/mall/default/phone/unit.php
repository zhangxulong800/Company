<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    function add(){
        ...
        gramNew=$("#<?php echo $module['module_name'];?> #gram_new");	
        ...
        $.get('<?php echo $module['action_url'];?>&act=add',{name:nameNew.prop('value'),gram:gramNew.prop('value'),sequence:sequenceNew.prop('value')}, function(data){
            //alert(data);
    ...
    function update(id){
        ...
        var gram=$("#<?php echo $module['module_name'];?> #gram_"+id);	
        ...
        $.get('<?php echo $module['action_url'];?>&act=update',{name:name.prop('value'),gram:gram.prop('value'),sequence:sequence.prop('value'),id:id}, function(data){
            //alert(data);
            try{v=eval("("+data+")");}catch(exception){alert(data);}
    ...
    <div class=table_scroll><table class="table table-striped table-bordered table-hover dataTable no-footer"  role="grid" style="width:100%" cellpadding="0" cellspacing="0">
         <thead>
            <tr>
                ...
                <td><?php echo self::$language['gram_remark']?></td>
        ...
        <tbody>
            ...
            <tr id="<?php echo $module['module_name'];?>_new">
              ...
              <td >=<input type="text" name="gram_new" id="gram_new" class='gram' value="0" /><?php echo self::$language['gram']?></td>
