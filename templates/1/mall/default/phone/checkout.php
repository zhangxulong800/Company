<div id=<?php echo $module['module_name'];?> monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?> .input_div{ display:inline-block; vertical-align:middle;  height:1.8rem;  line-height:1.8rem; overflow:hidden; padding:0px;}
	#<?php echo $module['module_name'];?> .input_div input{ display:inline-block; vertical-align:top; margin:0px; border:none; outline:none;height:1.7rem;  line-height:1.7rem; }
	#<?php echo $module['module_name'];?> .input_div a{ display:inline-block;  border:1px #FFFFFF solid; height:1.78rem; overflow:hidden; padding-left:0.5rem; padding-right:0.5rem;}
	...
	#<?php echo $module['module_name'];?> .line .input_div{ display:inline-block; vertical-align:middle;  height:3.5rem;  line-height:3.5rem; overflow:hidden; padding:0px; font-size:1.6rem;}
	#<?php echo $module['module_name'];?> .line .input_div input{ display:inline-block; vertical-align:top; margin:0px; border:none; outline:none;height:3.48rem;  line-height:3.48rem;  font-size:1.6rem;}
	#<?php echo $module['module_name'];?> .line .input_div a{ display:inline-block;  border:1px #FFFFFF solid; height:3.48rem; overflow:hidden; padding-left:0.5rem; padding-right:0.5rem;}
	
	
	#<?php echo $module['module_name'];?> .checkout_header{  position:fixed; top:0px;left:0px; width:100%; height:6rem;   border-bottom:#28a03a solid 0.3rem;}
	#<?php echo $module['module_name'];?> .checkout_header a{ }
	#<?php echo $module['module_name'];?> .checkout_header .icon{ display:inline-block; vertical-align:top; width:8%; border-right:1px solid #28a03a; overflow:hidden; text-align:center; height:100%;}
	#<?php echo $module['module_name'];?> .checkout_header .icon a{ display:block;}
	#<?php echo $module['module_name'];?> .checkout_header .icon a img{ width:4rem; height:4rem; margin-top:1rem; border-radius:4rem;  border:2px solid #FFFFFF;}
	#<?php echo $module['module_name'];?> .checkout_header .other{ display:inline-block; vertical-align:top; width:92%; overflow:hidden;}
	#<?php echo $module['module_name'];?> .checkout_header .other .shop_info{ padding-left:2rem; line-height:2.5rem; border-bottom:1px solid #28a03a;}
	#<?php echo $module['module_name'];?> .checkout_header .other .shop_info .info_fulfil{ display:inline-block; vertical-align:top; width:80%; overflow:hidden; white-space:nowrap; text-overflow: ellipsis;}
	...
	#<?php echo $module['module_name'];?> .checkout_header .other .shop_info .cashier{ display:inline-block; vertical-align:top; width:19%; margin-right:1rem; text-align:right;overflow:hidden; white-space:nowrap; text-overflow: ellipsis;}
	#<?php echo $module['module_name'];?> .checkout_header .other .shop_info .cashier a:hover{ font-weight:bold;}
	#<?php echo $module['module_name'];?> .checkout_header .other .shop_info .cashier .unlogin{ display:inline-block; line-height:2rem; padding-left:0.5rem; padding-right:0.5rem; border-radius:5px; }
	#<?php echo $module['module_name'];?> .checkout_header .other .shop_info .cashier .unlogin:hover{ }
	...
	#<?php echo $module['module_name'];?> .checkout_header .other .user_act .act_div .act_left{ width:50%; display:inline-block; vertical-align:top;}
	...
	#<?php echo $module['module_name'];?> .checkout_middle{  padding-top:6.3rem; padding-bottom:3rem;}
	#<?php echo $module['module_name'];?> .checkout_middle{}
	
	#<?php echo $module['module_name'];?> .checkout_footer{ padding-left:3rem; position:fixed; bottom:0px;left:0px; width:100%; height:3rem; line-height:3rem;  }
	#<?php echo $module['module_name'];?> .checkout_footer a{ display:inline-block; vertical-align:top; line-height:2rem; margin-top:0.5rem; margin-right:1rem; padding-left:5px; padding-right:5px;   border-radius:5px;}
	#<?php echo $module['module_name'];?> .checkout_footer a:hover{ }
	...
	#<?php echo $module['module_name'];?> .goods_info .title{ vertical-align:top;display:inline-block; vertical-align:top; width:410px; padding-left:10px; height:80px;line-height:25px; font-size:15px; overflow:hidden; white-space:normal;  }	
	...
	#<?php echo $module['module_name'];?>_html .checkout_left{ position:fixed; display:inline-block; vertical-align:top; white-space:nowrap; width:30%; padding:1rem; overflow:hidden; height:100%; } 
	...
	#<?php echo $module['module_name'];?>_html .checkout_left .input_div .barcode{ height:3rem; line-height:3rem;}
	...
	#<?php echo $module['module_name'];?>_html .checkout_right{position:fixed; right:0px; display:inline-block; vertical-align:top; width:70%; height:600px; overflow:scroll; overflow-x:hidden; white-space:nowrap; height:100%;}   
	...
	#<?php echo $module['module_name'];?>_html .thead{ position:fixed; white-space:nowrap; height:2rem; line-height:2rem; width:80%;  }
	#<?php echo $module['module_name'];?>_html .thead span{ display:inline-block; vertical-align:top; text-align:center;}
	#<?php echo $module['module_name'];?>_html .table_scroll{ padding-top:2rem; margin-top:0px; border:none;}
	...
	#<?php echo $module['module_name'];?>_html .quantity_div{ width:18%; overflow:hidden; white-space:nowrap;}
    ...
    <div id="<?php echo $module['module_name'];?>_html"  monxin-table=1>
    	<div class=checkout_header>
        	<div class=icon><a href=./index.php  target="_blank"><img src='./program/mall/shop_icon/<?php echo $module['shop_id']?>.png' /></a></div><div class=other>
            	<div class=shop_info>
                    ...
                    <div class="cashier"><?php echo self::$language['cashier'];?>：<a href="./index.php?monxin=index.user" target="_blank" class=cashier_username><?php echo $module['username']?></a> <a  class="unlogin" id="unlogin" href="./receive.php?target=index::user&act=unlogin"><?php echo self::$language['unlogin_short']?></a></div>
                </div>
                <div class=user_act>
                	<div id=user_info><?php echo self::$language['member']?><?php echo self::$language['info']?>：<span class=value><div class=input_div><input type="password" class=user placeholder="<?php echo self::$language['phone']?>/<?php echo self::$language['membership']?>"  /><a><?php echo self::$language['enter']?></a></div> <span class=user_state></span></span></div><div class="act_div">
                        <div class=act_right>
    	...
    	<div class=checkout_middle>
            ...
            <div class=checkout_left>
               <div class=line><span class=m_label><?php echo self::$language['barcode']?>:</span><span class=value>
                   <div class=input_div>
                        <input type="text" class=barcode placeholder="<?php echo self::$language['goods_name_or_barcode']?>" /><a style=""><?php echo self::$language['enter']?></a></div>
    	...
    	<div class=checkout_footer>
        	<div class=hot_key>
                ...
                <a ><?php echo self::$language['checkout_and_print']?>：<?php echo self::$language['space_key']?>(Space)</a>
                <a><?php echo self::$language['barcode_focus']?>：Shift+q</a>
                <a ><?php echo self::$language['user_focus']?>：Shift+a</a>
                <a ><?php echo self::$language['received_money_focus']?>：Shift+z</a>
                <a ><?php echo self::$language['empty_checkout']?>：Shift+x</a>
            </div>        
        </div>
