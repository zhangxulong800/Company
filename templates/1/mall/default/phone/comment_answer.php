<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?>_html{margin:0.5rem; }
    #<?php echo $module['module_name'];?>_html .goods_title{ line-height:40px;}
    #<?php echo $module['module_name'];?>_html #answer{ width:100%; height:100px;}
	...
	#<?php echo $module['module_name'];?> .buyer .point:after{ color:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>; font: normal normal normal 1rem/1 FontAwesome; content:"\f0d9";}
    #<?php echo $module['module_name'];?> .buyer .content{ line-height:25px; display:inline-block; vertical-align:top; padding-left:10px;  padding-right:10px; border-radius:5px;  font-size:1rem;background:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['monxin_user_color_set']['nv_1_hover']['text']?>;}
