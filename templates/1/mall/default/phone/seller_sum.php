<div id=<?php echo $module['module_name'];?>  class="portlet light sum_card" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    [expiration] .goods_info{ display:block;line-height:2rem; width:12rem; height:2rem;overflow:hidden; white-space:nowrap;}
    [expiration] .goods_info img{display:inline-block; vertical-align:top; height:2rem; border:none; margin-right:3px;}
    [expiration] .goods_info span{display:inline-block; vertical-align:top; width:90%; overflow:hidden;text-overflow: ellipsis;}
    </style>
...
<div class="modal fade" id="myModal" expiration=1 tabindex="-1" role="dialog" 
