<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?> .time{ display:block; width:100px;}
    </style>
    <div id="<?php echo $module['module_name'];?>_html"  monxin-table=1>
    
    <div class="portlet-title">
        <div class="caption"><?php echo $module['monxin_table_name']?></div>
        <div class="actions"><a href=./index.php?monxin=index.my_recommend_qr class=add><?php echo self::$language['functions']['mall.my_recommend']['description']?></a></div>
    </div>
    ...
    <div class=table_scroll><table class="table table-striped table-bordered table-hover dataTable no-footer"  role="grid"  id="<?php echo $module['module_name'];?>_table" style="width:100%" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <td ><span class=time><?php echo self::$language['order_state'][6]?><?php echo self::$language['time']?></span></td>
            </tr>
        </thead>
        <tbody>
