   ...
   <style>
    ...
    <div id="<?php echo $module['module_name'];?>_html" monxin-table=1>
        ...
        <div class="filter">
            ...
            <span id=time_limit class=limit><?php echo $module['days'];?><br /><span class=start_time_span><?php echo self::$language['start_time']?></span><input type="text" id="start_time" name="start_time" value="<?php echo @$_GET['start_time'];?>"  onclick=show_datePicker(this.id,'date') onblur= hide_datePicker()  /> -
