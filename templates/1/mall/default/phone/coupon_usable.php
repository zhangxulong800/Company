<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?>_html .list .coupon{ display:inline-block; vertical-align:top; width:45%; margin:2.5%; box-shadow: 0px 2px 5px 2px rgba(0, 0, 0, 0.1); margin-bottom:1rem;} 
	...
	#<?php echo $module['module_name'];?>_html .list .coupon .goods{ display:none; background-color:#fff;  text-align:center;padding:10px;} 
