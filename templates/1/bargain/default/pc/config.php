<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left >
	...
	<div id="<?php echo $module['module_name'];?>_html">
       ...
       <div class=line><span class=m_label><?php echo self::$language['bargain_limit'];?></span><span class=value><input type="text" class="bargain_limit" value="<?php echo $module['config']['bargain_limit']?>" /> <span class=state></span></span></div>
