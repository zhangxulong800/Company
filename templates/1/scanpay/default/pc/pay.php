<div id=<?php echo $module['module_name'];?>  class="portlet light" monxin-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    <style>
    #<?php echo $module['module_name'];?>{ padding-bottom:10rem;}
    #<?php echo $module['module_name'];?>_html{}
    #<?php echo $module['module_name'];?> .banner{ text-align:center;}
    #<?php echo $module['module_name'];?> .name{ text-align:center; font-family:"微软雅黑", "宋体"; font-size:20px; margin-top:-25px; margin-left:100px;}
	#<?php echo $module['module_name'];?> .name img{ margin-right:15px;}
	
	#<?php echo $module['module_name'];?> .line{ margin-top:15px; line-height:2rem;}
	#<?php echo $module['module_name'];?> .line .m_label{ display: inline-block; vertical-align:top; width:40%; padding-right:5px; text-align:right;}
	#<?php echo $module['module_name'];?> .line .m_input{  display: inline-block; vertical-align:top; width:50%;}
	
	#<?php echo $module['module_name'];?> .line .m_input input{ width:65%;}
	#<?php echo $module['module_name'];?> .banner_show{ height:9rem; margin-left:100px;}
	#<?php echo $module['module_name'];?> .submit { background:#009944; border-radius:2px; padding:5px 27px; line-height:20px; font-family:"微软雅黑", "宋体"; font-size:16px; margin-left:100px;}
